...
sealed class UnicodeEmoji(val unicode: String, val tone: SkinTone? = null) : Emoji() {
    ...
    companion object {
        ...
        private val emojiMap = mapOf<String, (SkinTone?) -> UnicodeEmoji>(
            "\ud83d\ude4c" to { skinTone -> RaisedHands(skinTone) },
            "\ud83d\udc4f" to { skinTone -> Clap(skinTone) },
            "\ud83d\udc4b" to { skinTone -> Wave(skinTone) },
            "\ud83d\udc4d" to { skinTone -> Thumbsup(skinTone) },
            "\ud83d\udc4e" to { skinTone -> Thumbsdown(skinTone) },
            "\ud83d\udc4a" to { skinTone -> Punch(skinTone) },
            "\u270a" to { skinTone -> Fist(skinTone) },
            "\u270c" to { skinTone -> V(skinTone) },
            "\ud83d\udc4c" to { skinTone -> OkHand(skinTone) },
            "\u270b" to { skinTone -> RaisedHand(skinTone) },
            "\ud83d\udc50" to { skinTone -> OpenHands(skinTone) },
            "\ud83d\udcaa" to { skinTone -> Muscle(skinTone) },
            "\ud83d\ude4f" to { skinTone -> Pray(skinTone) },
            "\u261d" to { skinTone -> PointUp(skinTone) },
            "\ud83d\udc46" to { skinTone -> PointUp2(skinTone) },
            "\ud83d\udc47" to { skinTone -> PointDown(skinTone) },
            "\ud83d\udc48" to { skinTone -> PointLeft(skinTone) },
            "\ud83d\udc49" to { skinTone -> PointRight(skinTone) },
            "\ud83d\udd95" to { skinTone -> MiddleFinger(skinTone) },
            "\ud83d\udd90" to { skinTone -> HandSplayed(skinTone) },
            "\ud83e\udd18" to { skinTone -> Metal(skinTone) },
            "\ud83d\udd96" to { skinTone -> Vulcan(skinTone) },
            "\u270d" to { skinTone -> WritingHand(skinTone) },
            "\ud83d\udc85" to { skinTone -> NailCare(skinTone) },
            "\ud83d\udc42" to { skinTone -> Ear(skinTone) },
            "\ud83d\udc43" to { skinTone -> Nose(skinTone) },
            "\ud83d\udc76" to { skinTone -> Baby(skinTone) },
            "\ud83d\udc66" to { skinTone -> Boy(skinTone) },
            "\ud83d\udc67" to { skinTone -> Girl(skinTone) },
            "\ud83d\udc68" to { skinTone -> Man(skinTone) },
            "\ud83d\udc69" to { skinTone -> Woman(skinTone) },
            "\ud83d\udc71" to { skinTone -> PersonWithBlondHair(skinTone) },
            "\ud83d\udc74" to { skinTone -> OlderMan(skinTone) },
            "\ud83d\udc75" to { skinTone -> OlderWoman(skinTone) },
            "\ud83d\udc72" to { skinTone -> ManWithGuaPiMao(skinTone) },
            "\ud83d\udc73" to { skinTone -> ManWithTurban(skinTone) },
            "\ud83d\udc6e" to { skinTone -> Cop(skinTone) },
            "\ud83d\udc77" to { skinTone -> ConstructionWorker(skinTone) },
            "\ud83d\udc82" to { skinTone -> Guardsman(skinTone) },
            "\ud83d\udd75" to { skinTone -> Spy(skinTone) },
            "\ud83c\udf85" to { skinTone -> Santa(skinTone) },
            "\ud83d\udc7c" to { skinTone -> Angel(skinTone) },
            "\ud83d\udc78" to { skinTone -> Princess(skinTone) },
            "\ud83d\udc70" to { skinTone -> BrideWithVeil(skinTone) },
            "\ud83d\udeb6" to { skinTone -> Walking(skinTone) },
            "\ud83c\udfc3" to { skinTone -> Running(skinTone) },
            "\ud83d\udc83" to { skinTone -> Dancer(skinTone) },
            "\ud83d\ude47" to { skinTone -> Bow(skinTone) },
            "\ud83d\udc81" to { skinTone -> InformationDeskPerson(skinTone) },
            "\ud83d\ude45" to { skinTone -> NoGood(skinTone) },
            "\ud83d\ude46" to { skinTone -> OkWoman(skinTone) },
            "\ud83d\ude4b" to { skinTone -> RaisingHand(skinTone) },
            "\ud83d\ude4e" to { skinTone -> PersonWithPoutingFace(skinTone) },
            "\ud83d\ude4d" to { skinTone -> PersonFrowning(skinTone) },
            "\ud83d\udc87" to { skinTone -> Haircut(skinTone) },
            "\ud83d\udc86" to { skinTone -> Massage(skinTone) },
            "\ud83e\udd34" to { skinTone -> Prince(skinTone) },
            "\ud83e\udd35" to { skinTone -> ManInTuxedo(skinTone) },
            "\ud83e\udd36" to { skinTone -> MrsClaus(skinTone) },
            "\ud83e\udd26" to { skinTone -> Facepalm(skinTone) },
            "\ud83e\udd37" to { skinTone -> Shrug(skinTone) },
            "\uD83E\uDD30" to { skinTone -> PregnantWoman(skinTone) },
            "\ud83e\udd33" to { skinTone -> Selfie(skinTone) },
            "\ud83d\udd7a" to { skinTone -> ManDancing(skinTone) },
            "\ud83e\udd19" to { skinTone -> CallMe(skinTone) },
            "\ud83e\udd1a" to { skinTone -> RaisedBackOfHand(skinTone) },
            "\ud83e\udd1e" to { skinTone -> LeftFist(skinTone) },
            "\ud83e\udd1c" to { skinTone -> RightFist(skinTone) },
            "\ud83e\udd1d" to { skinTone -> Handshake(skinTone) },
            "\ud83e\udd1e" to { skinTone -> FingersCrossed(skinTone) },
            "\ud83d\ude00" to { skinTone -> getNonSkinToneEmoji(skinTone, Grinning) },
            "\ud83d\ude2c" to { skinTone -> getNonSkinToneEmoji(skinTone, Grimacing) },
            "\ud83d\ude01" to { skinTone -> getNonSkinToneEmoji(skinTone, Grin) },
            "\ud83d\ude02" to { skinTone -> getNonSkinToneEmoji(skinTone, Joy) },
            "\ud83d\ude03" to { skinTone -> getNonSkinToneEmoji(skinTone, Smiley) },
            "\ud83d\ude04" to { skinTone -> getNonSkinToneEmoji(skinTone, Smile) },
            "\ud83d\ude05" to { skinTone -> getNonSkinToneEmoji(skinTone, SweatSmile) },
            "\ud83d\ude06" to { skinTone -> getNonSkinToneEmoji(skinTone, Laughing) },
            "\ud83d\ude07" to { skinTone -> getNonSkinToneEmoji(skinTone, Innocent) },
            "\ud83d\ude09" to { skinTone -> getNonSkinToneEmoji(skinTone, Wink) },
            "\ud83d\ude0a" to { skinTone -> getNonSkinToneEmoji(skinTone, Blush) },
            "\ud83d\ude42" to { skinTone -> getNonSkinToneEmoji(skinTone, SlightSmile) },
            "\ud83d\ude43" to { skinTone -> getNonSkinToneEmoji(skinTone, UpsideDown) },
            "\u263a" to { skinTone -> getNonSkinToneEmoji(skinTone, Relaxed) },
            "\ud83d\ude0b" to { skinTone -> getNonSkinToneEmoji(skinTone, Yum) },
            "\ud83d\ude0c" to { skinTone -> getNonSkinToneEmoji(skinTone, Relieved) },
            "\ud83d\ude0d" to { skinTone -> getNonSkinToneEmoji(skinTone, HeartEyes) },
            "\ud83d\ude18" to { skinTone -> getNonSkinToneEmoji(skinTone, KissingHeart) },
            "\ud83d\ude17" to { skinTone -> getNonSkinToneEmoji(skinTone, Kissing) },
            "\ud83d\ude19" to { skinTone -> getNonSkinToneEmoji(skinTone, KissingSmilingEyes) },
            "\ud83d\ude1a" to { skinTone -> getNonSkinToneEmoji(skinTone, KissingClosedEyes) },
            "\ud83d\ude1c" to { skinTone -> getNonSkinToneEmoji(skinTone, StuckOutTongueWinkingEye) },
            "\ud83d\ude1d" to { skinTone -> getNonSkinToneEmoji(skinTone, StuckOutTongueClosedEyes) },
            "\ud83d\ude1b" to { skinTone -> getNonSkinToneEmoji(skinTone, StuckOutTongue) },
            "\ud83e\udd11" to { skinTone -> getNonSkinToneEmoji(skinTone, MoneyMouth) },
            "\ud83e\udd13" to { skinTone -> getNonSkinToneEmoji(skinTone, Nerd) },
            "\ud83d\ude0e" to { skinTone -> getNonSkinToneEmoji(skinTone, Sunglasses) },
            "\ud83e\udd17" to { skinTone -> getNonSkinToneEmoji(skinTone, Hugging) },
            "\ud83d\ude0f" to { skinTone -> getNonSkinToneEmoji(skinTone, Smirk) },
            "\ud83d\ude36" to { skinTone -> getNonSkinToneEmoji(skinTone, NoMouth) },
            "\ud83d\ude10" to { skinTone -> getNonSkinToneEmoji(skinTone, NeutralFace) },
            "\ud83d\ude11" to { skinTone -> getNonSkinToneEmoji(skinTone, Expressionless) },
            "\ud83d\ude12" to { skinTone -> getNonSkinToneEmoji(skinTone, Unamused) },
            "\ud83d\ude44" to { skinTone -> getNonSkinToneEmoji(skinTone, RollingEyes) },
            "\ud83e\udd14" to { skinTone -> getNonSkinToneEmoji(skinTone, Thinking) },
            "\ud83d\ude33" to { skinTone -> getNonSkinToneEmoji(skinTone, Flushed) },
            "\ud83d\ude1e" to { skinTone -> getNonSkinToneEmoji(skinTone, Disappointed) },
            "\ud83d\ude1f" to { skinTone -> getNonSkinToneEmoji(skinTone, Worried) },
            "\ud83d\ude20" to { skinTone -> getNonSkinToneEmoji(skinTone, Angry) },
            "\ud83d\ude21" to { skinTone -> getNonSkinToneEmoji(skinTone, Rage) },
            "\ud83d\ude14" to { skinTone -> getNonSkinToneEmoji(skinTone, Pensive) },
            "\ud83d\ude15" to { skinTone -> getNonSkinToneEmoji(skinTone, Confused) },
            "\ud83d\ude41" to { skinTone -> getNonSkinToneEmoji(skinTone, SlightFrown) },
            "\u2639" to { skinTone -> getNonSkinToneEmoji(skinTone, Frowning2) },
            "\ud83d\ude23" to { skinTone -> getNonSkinToneEmoji(skinTone, Persevere) },
            "\ud83d\ude16" to { skinTone -> getNonSkinToneEmoji(skinTone, Confounded) },
            "\ud83d\ude2b" to { skinTone -> getNonSkinToneEmoji(skinTone, TiredFace) },
            "\ud83d\ude29" to { skinTone -> getNonSkinToneEmoji(skinTone, Weary) },
            "\ud83d\ude24" to { skinTone -> getNonSkinToneEmoji(skinTone, Triumph) },
            "\ud83d\ude2e" to { skinTone -> getNonSkinToneEmoji(skinTone, OpenMouth) },
            "\ud83d\ude31" to { skinTone -> getNonSkinToneEmoji(skinTone, Scream) },
            "\ud83d\ude28" to { skinTone -> getNonSkinToneEmoji(skinTone, Fearful) },
            "\ud83d\ude30" to { skinTone -> getNonSkinToneEmoji(skinTone, ColdSweat) },
            "\ud83d\ude2f" to { skinTone -> getNonSkinToneEmoji(skinTone, Hushed) },
            "\ud83d\ude26" to { skinTone -> getNonSkinToneEmoji(skinTone, Frowning) },
            "\ud83d\ude27" to { skinTone -> getNonSkinToneEmoji(skinTone, Anguished) },
            "\ud83d\ude22" to { skinTone -> getNonSkinToneEmoji(skinTone, Cry) },
            "\ud83d\ude25" to { skinTone -> getNonSkinToneEmoji(skinTone, DisappointedRelieved) },
            "\ud83d\ude2a" to { skinTone -> getNonSkinToneEmoji(skinTone, Sleepy) },
            "\ud83d\ude13" to { skinTone -> getNonSkinToneEmoji(skinTone, Sweat) },
            "\ud83d\ude2d" to { skinTone -> getNonSkinToneEmoji(skinTone, Sob) },
            "\ud83d\ude35" to { skinTone -> getNonSkinToneEmoji(skinTone, DizzyFace) },
            "\ud83d\ude32" to { skinTone -> getNonSkinToneEmoji(skinTone, Astonished) },
            "\ud83e\udd10" to { skinTone -> getNonSkinToneEmoji(skinTone, ZipperMouth) },
            "\ud83d\ude37" to { skinTone -> getNonSkinToneEmoji(skinTone, Mask) },
            "\ud83e\udd12" to { skinTone -> getNonSkinToneEmoji(skinTone, ThermometerFace) },
            "\ud83e\udd15" to { skinTone -> getNonSkinToneEmoji(skinTone, HeadBandage) },
            "\ud83d\ude34" to { skinTone -> getNonSkinToneEmoji(skinTone, Sleeping) },
            "\ud83d\udca4" to { skinTone -> getNonSkinToneEmoji(skinTone, Zzz) },
            "\ud83d\udca9" to { skinTone -> getNonSkinToneEmoji(skinTone, Poop) },
            "\ud83d\ude08" to { skinTone -> getNonSkinToneEmoji(skinTone, SmilingImp) },
            "\ud83d\udc7f" to { skinTone -> getNonSkinToneEmoji(skinTone, Imp) },
            "\ud83d\udc79" to { skinTone -> getNonSkinToneEmoji(skinTone, JapaneseOgre) },
            "\ud83d\udc7a" to { skinTone -> getNonSkinToneEmoji(skinTone, JapaneseGoblin) },
            "\ud83d\udc80" to { skinTone -> getNonSkinToneEmoji(skinTone, Skull) },
            "\ud83d\udc7b" to { skinTone -> getNonSkinToneEmoji(skinTone, Ghost) },
            "\ud83d\udc7d" to { skinTone -> getNonSkinToneEmoji(skinTone, Alien) },
            "\ud83e\udd16" to { skinTone -> getNonSkinToneEmoji(skinTone, Robot) },
            "\ud83d\ude3a" to { skinTone -> getNonSkinToneEmoji(skinTone, SmileyCat) },
            "\ud83d\ude38" to { skinTone -> getNonSkinToneEmoji(skinTone, SmileCat) },
            "\ud83d\ude39" to { skinTone -> getNonSkinToneEmoji(skinTone, JoyCat) },
            "\ud83d\ude3b" to { skinTone -> getNonSkinToneEmoji(skinTone, HeartEyesCat) },
            "\ud83d\ude3c" to { skinTone -> getNonSkinToneEmoji(skinTone, SmirkCat) },
            "\ud83d\ude3d" to { skinTone -> getNonSkinToneEmoji(skinTone, KissingCat) },
            "\ud83d\ude40" to { skinTone -> getNonSkinToneEmoji(skinTone, ScreamCat) },
            "\ud83d\ude3f" to { skinTone -> getNonSkinToneEmoji(skinTone, CryingCatFace) },
            "\ud83d\ude3e" to { skinTone -> getNonSkinToneEmoji(skinTone, PoutingCat) },
            "\ud83d\udc44" to { skinTone -> getNonSkinToneEmoji(skinTone, Lips) },
            "\ud83d\udc45" to { skinTone -> getNonSkinToneEmoji(skinTone, Tongue) },
            "\ud83d\udc41" to { skinTone -> getNonSkinToneEmoji(skinTone, Eye) },
            "\ud83d\udc40" to { skinTone -> getNonSkinToneEmoji(skinTone, Eyes) },
            "\ud83d\udc64" to { skinTone -> getNonSkinToneEmoji(skinTone, BustInSilhouette) },
            "\ud83d\udc65" to { skinTone -> getNonSkinToneEmoji(skinTone, BustsInSilhouette) },
            "\ud83d\udde3" to { skinTone -> getNonSkinToneEmoji(skinTone, SpeakingHead) },
            "\ud83d\udc6f" to { skinTone -> getNonSkinToneEmoji(skinTone, Dancers) },
            "\ud83d\udc6b" to { skinTone -> getNonSkinToneEmoji(skinTone, Couple) },
            "\ud83d\udc6c" to { skinTone -> getNonSkinToneEmoji(skinTone, TwoMenHoldingHands) },
            "\ud83d\udc6d" to { skinTone -> getNonSkinToneEmoji(skinTone, TwoWomenHoldingHands) },
            "\ud83d\udc91" to { skinTone -> getNonSkinToneEmoji(skinTone, CoupleWithHeart) },
            "\ud83d\udc69\u200d\u2764\ufe0f\u200d\ud83d\udc69"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, CoupleWW) },
            "\ud83d\udc68\u200d\u2764\ufe0f\u200d\ud83d\udc68"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, CoupleMM) },
            "\ud83d\udc8f" to { skinTone -> getNonSkinToneEmoji(skinTone, Couplekiss) },
            "\ud83d\udc69\u200d\u2764\ufe0f\u200d\ud83d\udc8b\u200d\ud83d\udc69"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, KissWW) },
            "\ud83d\udc68\u200d\u2764\ufe0f\u200d\ud83d\udc8b\u200d\ud83d\udc68"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, KissMM) },
            "\ud83d\udc6a" to { skinTone -> getNonSkinToneEmoji(skinTone, Family) },
            "\ud83d\udc68\u200d\ud83d\udc69\u200d\ud83d\udc67"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, FamilyMwg) },
            "\ud83d\udc68\u200d\ud83d\udc69\u200d\ud83d\udc67\u200d\ud83d\udc66"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, FamilyMwgb) },
            "\ud83d\udc68\u200d\ud83d\udc69\u200d\ud83d\udc66\u200d\ud83d\udc66"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, FamilyMwbb) },
            "\ud83d\udc68\u200d\ud83d\udc69\u200d\ud83d\udc67\u200d\ud83d\udc67"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, FamilyMwgg) },
            "\ud83d\udc69\u200d\ud83d\udc69\u200d\ud83d\udc66"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, FamilyWwb) },
            "\ud83d\udc69\u200d\ud83d\udc69\u200d\ud83d\udc67"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, FamilyWwg) },
            "\ud83d\udc69\u200d\ud83d\udc69\u200d\ud83d\udc67\u200d\ud83d\udc66"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, FamilyWwgb) },
            "\ud83d\udc69\u200d\ud83d\udc69\u200d\ud83d\udc66\u200d\ud83d\udc66"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, FamilyWwbb) },
            "\ud83d\udc69\u200d\ud83d\udc69\u200d\ud83d\udc67\u200d\ud83d\udc67"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, FamilyWwgg) },
            "\ud83d\udc68\u200d\ud83d\udc68\u200d\ud83d\udc66"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, FamilyMmb) },
            "\ud83d\udc68\u200d\ud83d\udc68\u200d\ud83d\udc67"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, FamilyMmg) },
            "\ud83d\udc68\u200d\ud83d\udc68\u200d\ud83d\udc67\u200d\ud83d\udc66"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, FamilyMmgb) },
            "\ud83d\udc68\u200d\ud83d\udc68\u200d\ud83d\udc66\u200d\ud83d\udc66"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, FamilyMmbb) },
            "\ud83d\udc68\u200d\ud83d\udc68\u200d\ud83d\udc67\u200d\ud83d\udc67"
                    to { skinTone -> getNonSkinToneEmoji(skinTone, FamilyMmgg) },
            "\ud83d\udc5a" to { skinTone -> getNonSkinToneEmoji(skinTone, WomansClothes) },
            "\ud83d\udc55" to { skinTone -> getNonSkinToneEmoji(skinTone, Shirt) },
            "\ud83d\udc56" to { skinTone -> getNonSkinToneEmoji(skinTone, Jeans) },
            "\ud83d\udc54" to { skinTone -> getNonSkinToneEmoji(skinTone, Necktie) },
            "\ud83d\udc57" to { skinTone -> getNonSkinToneEmoji(skinTone, Dress) },
            "\ud83d\udc59" to { skinTone -> getNonSkinToneEmoji(skinTone, Bikini) },
            "\ud83d\udc58" to { skinTone -> getNonSkinToneEmoji(skinTone, Kimono) },
            "\ud83d\udc84" to { skinTone -> getNonSkinToneEmoji(skinTone, Lipstick) },
            "\ud83d\udc8b" to { skinTone -> getNonSkinToneEmoji(skinTone, Kiss) },
            "\ud83d\udc63" to { skinTone -> getNonSkinToneEmoji(skinTone, Footprints) },
            "\ud83d\udc60" to { skinTone -> getNonSkinToneEmoji(skinTone, HighHeel) },
            "\ud83d\udc61" to { skinTone -> getNonSkinToneEmoji(skinTone, Sandal) },
            "\ud83d\udc62" to { skinTone -> getNonSkinToneEmoji(skinTone, Boot) },
            "\ud83d\udc5e" to { skinTone -> getNonSkinToneEmoji(skinTone, Shoe) },
            "\ud83d\udc5f" to { skinTone -> getNonSkinToneEmoji(skinTone, AthleticShoe) },
            "\ud83d\udc52" to { skinTone -> getNonSkinToneEmoji(skinTone, WomansHat) },
            "\ud83c\udfa9" to { skinTone -> getNonSkinToneEmoji(skinTone, Tophat) },
            "\u26d1" to { skinTone -> getNonSkinToneEmoji(skinTone, HelmetWithCross) },
            "\ud83c\udf93" to { skinTone -> getNonSkinToneEmoji(skinTone, MortarBoard) },
            "\ud83d\udc51" to { skinTone -> getNonSkinToneEmoji(skinTone, Crown) },
            "\ud83c\udf92" to { skinTone -> getNonSkinToneEmoji(skinTone, SchoolSatchel) },
            "\ud83d\udc5d" to { skinTone -> getNonSkinToneEmoji(skinTone, Pouch) },
            "\ud83d\udc5b" to { skinTone -> getNonSkinToneEmoji(skinTone, Purse) },
            "\ud83d\udc5c" to { skinTone -> getNonSkinToneEmoji(skinTone, Handbag) },
            "\ud83d\udcbc" to { skinTone -> getNonSkinToneEmoji(skinTone, Briefcase) },
            "\ud83d\udc53" to { skinTone -> getNonSkinToneEmoji(skinTone, Eyeglasses) },
            "\ud83d\udd76" to { skinTone -> getNonSkinToneEmoji(skinTone, DarkSunglasses) },
            "\ud83d\udc8d" to { skinTone -> getNonSkinToneEmoji(skinTone, Ring) },
            "\ud83c\udf02" to { skinTone -> getNonSkinToneEmoji(skinTone, ClosedUmbrella) },
            "\ud83e\udd20" to { skinTone -> getNonSkinToneEmoji(skinTone, Cowboy) },
            "\ud83e\udd21" to { skinTone -> getNonSkinToneEmoji(skinTone, Clown) },
            "\ud83e\udd22" to { skinTone -> getNonSkinToneEmoji(skinTone, Sick) },
            "\ud83e\udd23" to { skinTone -> getNonSkinToneEmoji(skinTone, Rofl) },
            "\ud83e\udd24" to { skinTone -> getNonSkinToneEmoji(skinTone, Drool) },
            "\ud83e\udd25" to { skinTone -> getNonSkinToneEmoji(skinTone, Lying) },
            "\ud83e\udd27" to { skinTone -> getNonSkinToneEmoji(skinTone, Sneeze) },
            "\ud83d\udc36" to { skinTone -> getNonSkinToneEmoji(skinTone, Dog) },
            "\ud83d\udc31" to { skinTone -> getNonSkinToneEmoji(skinTone, Cat) },
            "\ud83d\udc2d" to { skinTone -> getNonSkinToneEmoji(skinTone, Mouse) },
            "\ud83d\udc39" to { skinTone -> getNonSkinToneEmoji(skinTone, Hamster) },
            "\ud83d\udc30" to { skinTone -> getNonSkinToneEmoji(skinTone, Rabbit) },
            "\ud83d\udc3b" to { skinTone -> getNonSkinToneEmoji(skinTone, Bear) },
            "\ud83d\udc3c" to { skinTone -> getNonSkinToneEmoji(skinTone, PandaFace) },
            "\ud83d\udc28" to { skinTone -> getNonSkinToneEmoji(skinTone, Koala) },
            "\ud83d\udc2f" to { skinTone -> getNonSkinToneEmoji(skinTone, Tiger) },
            "\ud83e\udd81" to { skinTone -> getNonSkinToneEmoji(skinTone, LionFace) },
            "\ud83d\udc2e" to { skinTone -> getNonSkinToneEmoji(skinTone, Cow) },
            "\ud83d\udc37" to { skinTone -> getNonSkinToneEmoji(skinTone, Pig) },
            "\ud83d\udc3d" to { skinTone -> getNonSkinToneEmoji(skinTone, PigNose) },
            "\ud83d\udc38" to { skinTone -> getNonSkinToneEmoji(skinTone, Frog) },
            "\ud83d\udc19" to { skinTone -> getNonSkinToneEmoji(skinTone, Octopus) },
            "\ud83d\udc35" to { skinTone -> getNonSkinToneEmoji(skinTone, MonkeyFace) },
            "\ud83d\ude48" to { skinTone -> getNonSkinToneEmoji(skinTone, SeeNoEvil) },
            "\ud83d\ude49" to { skinTone -> getNonSkinToneEmoji(skinTone, HearNoEvil) },
            "\ud83d\ude4a" to { skinTone -> getNonSkinToneEmoji(skinTone, SpeakNoEvil) },
            "\ud83d\udc12" to { skinTone -> getNonSkinToneEmoji(skinTone, Monkey) },
            "\ud83d\udc14" to { skinTone -> getNonSkinToneEmoji(skinTone, Chicken) },
            "\ud83d\udc27" to { skinTone -> getNonSkinToneEmoji(skinTone, Penguin) },
            "\ud83d\udc26" to { skinTone -> getNonSkinToneEmoji(skinTone, Bird) },
            "\ud83d\udc24" to { skinTone -> getNonSkinToneEmoji(skinTone, BabyChick) },
            "\ud83d\udc23" to { skinTone -> getNonSkinToneEmoji(skinTone, HatchingChick) },
            "\ud83d\udc25" to { skinTone -> getNonSkinToneEmoji(skinTone, HatchedChick) },
            "\ud83d\udc3a" to { skinTone -> getNonSkinToneEmoji(skinTone, Wolf) },
            "\ud83d\udc17" to { skinTone -> getNonSkinToneEmoji(skinTone, Boar) },
            "\ud83d\udc34" to { skinTone -> getNonSkinToneEmoji(skinTone, Horse) },
            "\ud83e\udd84" to { skinTone -> getNonSkinToneEmoji(skinTone, Unicorn) },
            "\ud83d\udc1d" to { skinTone -> getNonSkinToneEmoji(skinTone, Bee) },
            "\ud83d\udc1b" to { skinTone -> getNonSkinToneEmoji(skinTone, Bug) },
            "\ud83d\udc0c" to { skinTone -> getNonSkinToneEmoji(skinTone, Snail) },
            "\ud83d\udc1e" to { skinTone -> getNonSkinToneEmoji(skinTone, Beetle) },
            "\ud83d\udc1c" to { skinTone -> getNonSkinToneEmoji(skinTone, Ant) },
            "\ud83d\udd77" to { skinTone -> getNonSkinToneEmoji(skinTone, Spider) },
            "\ud83e\udd82" to { skinTone -> getNonSkinToneEmoji(skinTone, Scorpion) },
            "\ud83e\udd80" to { skinTone -> getNonSkinToneEmoji(skinTone, Crab) },
            "\ud83d\udc0d" to { skinTone -> getNonSkinToneEmoji(skinTone, Snake) },
            "\ud83d\udc22" to { skinTone -> getNonSkinToneEmoji(skinTone, Turtle) },
            "\ud83d\udc20" to { skinTone -> getNonSkinToneEmoji(skinTone, TropicalFish) },
            "\ud83d\udc1f" to { skinTone -> getNonSkinToneEmoji(skinTone, Fish) },
            "\ud83d\udc21" to { skinTone -> getNonSkinToneEmoji(skinTone, Blowfish) },
            "\ud83d\udc2c" to { skinTone -> getNonSkinToneEmoji(skinTone, Dolphin) },
            "\ud83d\udc33" to { skinTone -> getNonSkinToneEmoji(skinTone, Whale) },
            "\ud83d\udc0b" to { skinTone -> getNonSkinToneEmoji(skinTone, Whale2) },
            "\ud83d\udc0a" to { skinTone -> getNonSkinToneEmoji(skinTone, Crocodile) },
            "\ud83d\udc06" to { skinTone -> getNonSkinToneEmoji(skinTone, Leopard) },
            "\ud83d\udc05" to { skinTone -> getNonSkinToneEmoji(skinTone, Tiger2) },
            "\ud83d\udc03" to { skinTone -> getNonSkinToneEmoji(skinTone, WaterBuffalo) },
            "\ud83d\udc02" to { skinTone -> getNonSkinToneEmoji(skinTone, Ox) },
            "\ud83d\udc04" to { skinTone -> getNonSkinToneEmoji(skinTone, Cow2) },
            "\ud83d\udc2a" to { skinTone -> getNonSkinToneEmoji(skinTone, DromedaryCamel) },
            "\ud83d\udc2b" to { skinTone -> getNonSkinToneEmoji(skinTone, Camel) },
            "\ud83d\udc18" to { skinTone -> getNonSkinToneEmoji(skinTone, Elephant) },
            "\ud83d\udc10" to { skinTone -> getNonSkinToneEmoji(skinTone, Goat) },
            "\ud83d\udc0f" to { skinTone -> getNonSkinToneEmoji(skinTone, Ram) },
            "\ud83d\udc11" to { skinTone -> getNonSkinToneEmoji(skinTone, Sheep) },
            "\ud83d\udc0e" to { skinTone -> getNonSkinToneEmoji(skinTone, Racehorse) },
            "\ud83d\udc16" to { skinTone -> getNonSkinToneEmoji(skinTone, Pig2) },
            "\ud83d\udc00" to { skinTone -> getNonSkinToneEmoji(skinTone, Rat) },
            "\ud83d\udc01" to { skinTone -> getNonSkinToneEmoji(skinTone, Mouse2) },
            "\ud83d\udc13" to { skinTone -> getNonSkinToneEmoji(skinTone, Rooster) },
            "\ud83e\udd83" to { skinTone -> getNonSkinToneEmoji(skinTone, Turkey) },
            "\ud83d\udd4a" to { skinTone -> getNonSkinToneEmoji(skinTone, Dove) },
            "\ud83d\udc15" to { skinTone -> getNonSkinToneEmoji(skinTone, Dog2) },
            "\ud83d\udc29" to { skinTone -> getNonSkinToneEmoji(skinTone, Poodle) },
            "\ud83d\udc08" to { skinTone -> getNonSkinToneEmoji(skinTone, Cat2) },
            "\ud83d\udc07" to { skinTone -> getNonSkinToneEmoji(skinTone, Rabbit2) },
            "\ud83d\udc3f" to { skinTone -> getNonSkinToneEmoji(skinTone, Chipmunk) },
            "\ud83d\udc3e" to { skinTone -> getNonSkinToneEmoji(skinTone, PawPrints) },
            "\ud83d\udc09" to { skinTone -> getNonSkinToneEmoji(skinTone, Dragon) },
            "\ud83d\udc32" to { skinTone -> getNonSkinToneEmoji(skinTone, DragonFace) },
            "\ud83c\udf35" to { skinTone -> getNonSkinToneEmoji(skinTone, Cactus) },
            "\ud83c\udf84" to { skinTone -> getNonSkinToneEmoji(skinTone, ChristmasTree) },
            "\ud83c\udf32" to { skinTone -> getNonSkinToneEmoji(skinTone, EvergreenTree) },
            "\ud83c\udf33" to { skinTone -> getNonSkinToneEmoji(skinTone, DeciduousTree) },
            "\ud83c\udf34" to { skinTone -> getNonSkinToneEmoji(skinTone, PalmTree) },
            "\ud83c\udf31" to { skinTone -> getNonSkinToneEmoji(skinTone, Seedling) },
            "\ud83c\udf3f" to { skinTone -> getNonSkinToneEmoji(skinTone, Herb) },
            "\u2618" to { skinTone -> getNonSkinToneEmoji(skinTone, Shamrock) },
            "\ud83c\udf40" to { skinTone -> getNonSkinToneEmoji(skinTone, FourLeafClover) },
            "\ud83c\udf8d" to { skinTone -> getNonSkinToneEmoji(skinTone, Bamboo) },
            "\ud83c\udf8b" to { skinTone -> getNonSkinToneEmoji(skinTone, TanabataTree) },
            "\ud83c\udf43" to { skinTone -> getNonSkinToneEmoji(skinTone, Leaves) },
            "\ud83c\udf42" to { skinTone -> getNonSkinToneEmoji(skinTone, FallenLeaf) },
            "\ud83c\udf41" to { skinTone -> getNonSkinToneEmoji(skinTone, MapleLeaf) },
            "\ud83c\udf3e" to { skinTone -> getNonSkinToneEmoji(skinTone, EarOfRice) },
            "\ud83c\udf3a" to { skinTone -> getNonSkinToneEmoji(skinTone, Hibiscus) },
            "\ud83c\udf3b" to { skinTone -> getNonSkinToneEmoji(skinTone, Sunflower) },
            "\ud83c\udf39" to { skinTone -> getNonSkinToneEmoji(skinTone, Rose) },
            "\ud83c\udf37" to { skinTone -> getNonSkinToneEmoji(skinTone, Tulip) },
            "\ud83c\udf3c" to { skinTone -> getNonSkinToneEmoji(skinTone, Blossom) },
            "\ud83c\udf38" to { skinTone -> getNonSkinToneEmoji(skinTone, CherryBlossom) },
            "\ud83d\udc90" to { skinTone -> getNonSkinToneEmoji(skinTone, Bouquet) },
            "\ud83c\udf44" to { skinTone -> getNonSkinToneEmoji(skinTone, Mushroom) },
            "\ud83c\udf30" to { skinTone -> getNonSkinToneEmoji(skinTone, Chestnut) },
            "\ud83c\udf83" to { skinTone -> getNonSkinToneEmoji(skinTone, JackOLantern) },
            "\ud83d\udc1a" to { skinTone -> getNonSkinToneEmoji(skinTone, Shell) },
            "\ud83d\udd78" to { skinTone -> getNonSkinToneEmoji(skinTone, SpiderWeb) },
            "\ud83c\udf0e" to { skinTone -> getNonSkinToneEmoji(skinTone, EarthAmericas) },
            "\ud83c\udf0d" to { skinTone -> getNonSkinToneEmoji(skinTone, EarthAfrica) },
            "\ud83c\udf0f" to { skinTone -> getNonSkinToneEmoji(skinTone, EarthAsia) },
            "\ud83c\udf15" to { skinTone -> getNonSkinToneEmoji(skinTone, FullMoon) },
            "\ud83c\udf16" to { skinTone -> getNonSkinToneEmoji(skinTone, WaningGibbousMoon) },
            "\ud83c\udf17" to { skinTone -> getNonSkinToneEmoji(skinTone, LastQuarterMoon) },
            "\ud83c\udf18" to { skinTone -> getNonSkinToneEmoji(skinTone, WaningCrescentMoon) },
            "\ud83c\udf11" to { skinTone -> getNonSkinToneEmoji(skinTone, NewMoon) },
            "\ud83c\udf12" to { skinTone -> getNonSkinToneEmoji(skinTone, WaxingCrescentMoon) },
            "\ud83c\udf13" to { skinTone -> getNonSkinToneEmoji(skinTone, FirstQuarterMoon) },
            "\ud83c\udf14" to { skinTone -> getNonSkinToneEmoji(skinTone, Moon) },
            "\ud83c\udf1a" to { skinTone -> getNonSkinToneEmoji(skinTone, NewMoonWithFace) },
            "\ud83c\udf1d" to { skinTone -> getNonSkinToneEmoji(skinTone, FullMoonWithFace) },
            "\ud83c\udf1b" to { skinTone -> getNonSkinToneEmoji(skinTone, FirstQuarterMoonWithFace) },
            "\ud83c\udf1c" to { skinTone -> getNonSkinToneEmoji(skinTone, LastQuarterMoonWithFace) },
            "\ud83c\udf1e" to { skinTone -> getNonSkinToneEmoji(skinTone, SunWithFace) },
            "\ud83c\udf19" to { skinTone -> getNonSkinToneEmoji(skinTone, CrescentMoon) },
            "\u2b50" to { skinTone -> getNonSkinToneEmoji(skinTone, Star) },
            "\ud83c\udf1f" to { skinTone -> getNonSkinToneEmoji(skinTone, Star2) },
            "\ud83d\udcab" to { skinTone -> getNonSkinToneEmoji(skinTone, Dizzy) },
            "\u2728" to { skinTone -> getNonSkinToneEmoji(skinTone, Sparkles) },
            "\u2604" to { skinTone -> getNonSkinToneEmoji(skinTone, Comet) },
            "\u2600" to { skinTone -> getNonSkinToneEmoji(skinTone, Sunny) },
            "\ud83c\udf24" to { skinTone -> getNonSkinToneEmoji(skinTone, WhiteSunSmallCloud) },
            "\u26c5" to { skinTone -> getNonSkinToneEmoji(skinTone, PartlySunny) },
            "\ud83c\udf25" to { skinTone -> getNonSkinToneEmoji(skinTone, WhiteSunCloud) },
            "\ud83c\udf26" to { skinTone -> getNonSkinToneEmoji(skinTone, WhiteSunRainCloud) },
            "\u2601" to { skinTone -> getNonSkinToneEmoji(skinTone, Cloud) },
            "\ud83c\udf27" to { skinTone -> getNonSkinToneEmoji(skinTone, CloudRain) },
            "\u26c8" to { skinTone -> getNonSkinToneEmoji(skinTone, ThunderCloudRain) },
            "\ud83c\udf29" to { skinTone -> getNonSkinToneEmoji(skinTone, CloudLightning) },
            "\u26a1" to { skinTone -> getNonSkinToneEmoji(skinTone, Zap) },
            "\ud83d\udd25" to { skinTone -> getNonSkinToneEmoji(skinTone, Fire) },
            "\ud83d\udca5" to { skinTone -> getNonSkinToneEmoji(skinTone, Boom) },
            "\u2744" to { skinTone -> getNonSkinToneEmoji(skinTone, Snowflake) },
            "\ud83c\udf28" to { skinTone -> getNonSkinToneEmoji(skinTone, CloudSnow) },
            "\u2603" to { skinTone -> getNonSkinToneEmoji(skinTone, Snowman2) },
            "\u26c4" to { skinTone -> getNonSkinToneEmoji(skinTone, Snowman) },
            "\ud83c\udf2c" to { skinTone -> getNonSkinToneEmoji(skinTone, WindBlowingFace) },
            "\ud83d\udca8" to { skinTone -> getNonSkinToneEmoji(skinTone, Dash) },
            "\ud83c\udf2a" to { skinTone -> getNonSkinToneEmoji(skinTone, CloudTornado) },
            "\ud83c\udf2b" to { skinTone -> getNonSkinToneEmoji(skinTone, Fog) },
            "\u2602" to { skinTone -> getNonSkinToneEmoji(skinTone, Umbrella2) },
            "\u2614" to { skinTone -> getNonSkinToneEmoji(skinTone, Umbrella) },
            "\ud83d\udca7" to { skinTone -> getNonSkinToneEmoji(skinTone, Droplet) },
            "\ud83d\udca6" to { skinTone -> getNonSkinToneEmoji(skinTone, SweatDrops) },
            "\ud83c\udf0a" to { skinTone -> getNonSkinToneEmoji(skinTone, Ocean) },
            "\ud83e\udd85" to { skinTone -> getNonSkinToneEmoji(skinTone, Eagle) },
            "\ud83e\udd86" to { skinTone -> getNonSkinToneEmoji(skinTone, Duck) },
            "\ud83e\udd87" to { skinTone -> getNonSkinToneEmoji(skinTone, Bat) },
            "\ud83e\udd88" to { skinTone -> getNonSkinToneEmoji(skinTone, Shark) },
            "\ud83e\udd89" to { skinTone -> getNonSkinToneEmoji(skinTone, Owl) },
            "\ud83e\udd8a" to { skinTone -> getNonSkinToneEmoji(skinTone, Fox) },
            "\ud83e\udd8b" to { skinTone -> getNonSkinToneEmoji(skinTone, Butterfly) },
            "\ud83e\udd8c" to { skinTone -> getNonSkinToneEmoji(skinTone, Deer) },
            "\ud83e\udd8d" to { skinTone -> getNonSkinToneEmoji(skinTone, Gorilla) },
            "\ud83e\udd8e" to { skinTone -> getNonSkinToneEmoji(skinTone, Lizard) },
            "\ud83e\udd8f" to { skinTone -> getNonSkinToneEmoji(skinTone, Rhino) },
            "\ud83e\udd40" to { skinTone -> getNonSkinToneEmoji(skinTone, WiltedFlower) },
            "\ud83e\udd90" to { skinTone -> getNonSkinToneEmoji(skinTone, Shrimp) },
            "\ud83e\udd91" to { skinTone -> getNonSkinToneEmoji(skinTone, Squid) },
            "\ud83c\udf4f" to { skinTone -> getNonSkinToneEmoji(skinTone, GreenApple) },
            "\ud83c\udf4e" to { skinTone -> getNonSkinToneEmoji(skinTone, Apple) },
            "\ud83c\udf50" to { skinTone -> getNonSkinToneEmoji(skinTone, Pear) },
            "\ud83c\udf4a" to { skinTone -> getNonSkinToneEmoji(skinTone, Tangerine) },
            "\ud83c\udf4b" to { skinTone -> getNonSkinToneEmoji(skinTone, Lemon) },
            "\ud83c\udf4c" to { skinTone -> getNonSkinToneEmoji(skinTone, Banana) },
            "\ud83c\udf49" to { skinTone -> getNonSkinToneEmoji(skinTone, Watermelon) },
            "\ud83c\udf47" to { skinTone -> getNonSkinToneEmoji(skinTone, Grapes) },
            "\ud83c\udf53" to { skinTone -> getNonSkinToneEmoji(skinTone, Strawberry) },
            "\ud83c\udf48" to { skinTone -> getNonSkinToneEmoji(skinTone, Melon) },
            "\ud83c\udf52" to { skinTone -> getNonSkinToneEmoji(skinTone, Cherries) },
            "\ud83c\udf51" to { skinTone -> getNonSkinToneEmoji(skinTone, Peach) },
            "\ud83c\udf4d" to { skinTone -> getNonSkinToneEmoji(skinTone, Pineapple) },
            "\ud83c\udf45" to { skinTone -> getNonSkinToneEmoji(skinTone, Tomato) },
            "\ud83c\udf46" to { skinTone -> getNonSkinToneEmoji(skinTone, Eggplant) },
            "\ud83c\udf36" to { skinTone -> getNonSkinToneEmoji(skinTone, HotPepper) },
            "\ud83c\udf3d" to { skinTone -> getNonSkinToneEmoji(skinTone, Corn) },
            "\ud83c\udf60" to { skinTone -> getNonSkinToneEmoji(skinTone, SweetPotato) },
            "\ud83c\udf6f" to { skinTone -> getNonSkinToneEmoji(skinTone, HoneyPot) },
            "\ud83c\udf5e" to { skinTone -> getNonSkinToneEmoji(skinTone, Bread) },
            "\ud83e\uddc0" to { skinTone -> getNonSkinToneEmoji(skinTone, Cheese) },
            "\ud83c\udf57" to { skinTone -> getNonSkinToneEmoji(skinTone, PoultryLeg) },
            "\ud83c\udf56" to { skinTone -> getNonSkinToneEmoji(skinTone, MeatOnBone) },
            "\ud83c\udf64" to { skinTone -> getNonSkinToneEmoji(skinTone, FriedShrimp) },
            "\ud83c\udf73" to { skinTone -> getNonSkinToneEmoji(skinTone, Cooking) },
            "\ud83c\udf54" to { skinTone -> getNonSkinToneEmoji(skinTone, Hamburger) },
            "\ud83c\udf5f" to { skinTone -> getNonSkinToneEmoji(skinTone, Fries) },
            "\ud83c\udf2d" to { skinTone -> getNonSkinToneEmoji(skinTone, Hotdog) },
            "\ud83c\udf55" to { skinTone -> getNonSkinToneEmoji(skinTone, Pizza) },
            "\ud83c\udf5d" to { skinTone -> getNonSkinToneEmoji(skinTone, Spaghetti) },
            "\ud83c\udf2e" to { skinTone -> getNonSkinToneEmoji(skinTone, Taco) },
            "\ud83c\udf2f" to { skinTone -> getNonSkinToneEmoji(skinTone, Burrito) },
            "\ud83c\udf5c" to { skinTone -> getNonSkinToneEmoji(skinTone, Ramen) },
            "\ud83c\udf72" to { skinTone -> getNonSkinToneEmoji(skinTone, Stew) },
            "\ud83c\udf65" to { skinTone -> getNonSkinToneEmoji(skinTone, FishCake) },
            "\ud83c\udf63" to { skinTone -> getNonSkinToneEmoji(skinTone, Sushi) },
            "\ud83c\udf71" to { skinTone -> getNonSkinToneEmoji(skinTone, Bento) },
            "\ud83c\udf5b" to { skinTone -> getNonSkinToneEmoji(skinTone, Curry) },
            "\ud83c\udf59" to { skinTone -> getNonSkinToneEmoji(skinTone, RiceBall) },
            "\ud83c\udf5a" to { skinTone -> getNonSkinToneEmoji(skinTone, Rice) },
            "\ud83c\udf58" to { skinTone -> getNonSkinToneEmoji(skinTone, RiceCracker) },
            "\ud83c\udf62" to { skinTone -> getNonSkinToneEmoji(skinTone, Oden) },
            "\ud83c\udf61" to { skinTone -> getNonSkinToneEmoji(skinTone, Dango) },
            "\ud83c\udf67" to { skinTone -> getNonSkinToneEmoji(skinTone, ShavedIce) },
            "\ud83c\udf66" to { skinTone -> getNonSkinToneEmoji(skinTone, IceCream) },
            "\ud83c\udf70" to { skinTone -> getNonSkinToneEmoji(skinTone, Cake) },
            "\ud83c\udf82" to { skinTone -> getNonSkinToneEmoji(skinTone, Birthday) },
            "\ud83c\udf6e" to { skinTone -> getNonSkinToneEmoji(skinTone, Custard) },
            "\ud83c\udf6c" to { skinTone -> getNonSkinToneEmoji(skinTone, Candy) },
            "\ud83c\udf6d" to { skinTone -> getNonSkinToneEmoji(skinTone, Lollipop) },
            "\ud83c\udf6b" to { skinTone -> getNonSkinToneEmoji(skinTone, ChocolateBar) },
            "\ud83c\udf7f" to { skinTone -> getNonSkinToneEmoji(skinTone, Popcorn) },
            "\ud83c\udf69" to { skinTone -> getNonSkinToneEmoji(skinTone, Doughnut) },
            "\ud83c\udf6a" to { skinTone -> getNonSkinToneEmoji(skinTone, Cookie) },
            "\ud83c\udf7a" to { skinTone -> getNonSkinToneEmoji(skinTone, Beer) },
            "\ud83c\udf7b" to { skinTone -> getNonSkinToneEmoji(skinTone, Beers) },
            "\ud83c\udf77" to { skinTone -> getNonSkinToneEmoji(skinTone, WineGlass) },
            "\ud83c\udf78" to { skinTone -> getNonSkinToneEmoji(skinTone, Cocktail) },
            "\ud83c\udf79" to { skinTone -> getNonSkinToneEmoji(skinTone, TropicalDrink) },
            "\ud83c\udf7e" to { skinTone -> getNonSkinToneEmoji(skinTone, Champagne) },
            "\ud83c\udf76" to { skinTone -> getNonSkinToneEmoji(skinTone, Sake) },
            "\ud83c\udf75" to { skinTone -> getNonSkinToneEmoji(skinTone, Tea) },
            "\u2615" to { skinTone -> getNonSkinToneEmoji(skinTone, Coffee) },
            "\ud83c\udf7c" to { skinTone -> getNonSkinToneEmoji(skinTone, BabyBottle) },
            "\ud83c\udf74" to { skinTone -> getNonSkinToneEmoji(skinTone, ForkAndKnife) },
            "\ud83c\udf7d" to { skinTone -> getNonSkinToneEmoji(skinTone, ForkKnifePlate) },
            "\ud83e\udd50" to { skinTone -> getNonSkinToneEmoji(skinTone, Croissant) },
            "\ud83e\udd51" to { skinTone -> getNonSkinToneEmoji(skinTone, Avocado) },
            "\ud83e\udd52" to { skinTone -> getNonSkinToneEmoji(skinTone, Cucumber) },
            "\ud83e\udd53" to { skinTone -> getNonSkinToneEmoji(skinTone, Bacon) },
            "\ud83e\udd54" to { skinTone -> getNonSkinToneEmoji(skinTone, Potato) },
            "\ud83e\udd55" to { skinTone -> getNonSkinToneEmoji(skinTone, Carrot) },
            "\ud83e\udd56" to { skinTone -> getNonSkinToneEmoji(skinTone, FrenchBread) },
            "\ud83e\udd57" to { skinTone -> getNonSkinToneEmoji(skinTone, Salad) },
            "\ud83e\udd58" to { skinTone -> getNonSkinToneEmoji(skinTone, Paella) },
            "\ud83e\udd59" to { skinTone -> getNonSkinToneEmoji(skinTone, StuffedFlatbread) },
            "\ud83e\udd42" to { skinTone -> getNonSkinToneEmoji(skinTone, ClinkingGlass) },
            "\ud83e\udd43" to { skinTone -> getNonSkinToneEmoji(skinTone, Whisky) },
            "\ud83e\udd44" to { skinTone -> getNonSkinToneEmoji(skinTone, Spoon) },
            "\ud83e\udd5a" to { skinTone -> getNonSkinToneEmoji(skinTone, Egg) },
            "\ud83e\udd5b" to { skinTone -> getNonSkinToneEmoji(skinTone, Milk) },
            "\ud83e\udd5c" to { skinTone -> getNonSkinToneEmoji(skinTone, Peanuts) },
            "\ud83e\udd5d" to { skinTone -> getNonSkinToneEmoji(skinTone, Kiwi) },
            "\ud83e\udd5e" to { skinTone -> getNonSkinToneEmoji(skinTone, Pancakes) },
            "\u26bd" to { skinTone -> getNonSkinToneEmoji(skinTone, Soccer) },
            "\ud83c\udfc0" to { skinTone -> getNonSkinToneEmoji(skinTone, Basketball) },
            "\ud83c\udfc8" to { skinTone -> getNonSkinToneEmoji(skinTone, Football) },
            "\u26be" to { skinTone -> getNonSkinToneEmoji(skinTone, Baseball) },
            "\ud83c\udfbe" to { skinTone -> getNonSkinToneEmoji(skinTone, Tennis) },
            "\ud83c\udfd0" to { skinTone -> getNonSkinToneEmoji(skinTone, Volleyball) },
            "\ud83c\udfc9" to { skinTone -> getNonSkinToneEmoji(skinTone, RugbyFootball) },
            "\ud83c\udfb1" to { skinTone -> getNonSkinToneEmoji(skinTone, EightBall) },
            "\u26f3" to { skinTone -> getNonSkinToneEmoji(skinTone, Golf) },
            "\ud83c\udfcc" to { skinTone -> getNonSkinToneEmoji(skinTone, Golfer) },
            "\ud83c\udfd3" to { skinTone -> getNonSkinToneEmoji(skinTone, PingPong) },
            "\ud83c\udff8" to { skinTone -> getNonSkinToneEmoji(skinTone, Badminton) },
            "\ud83c\udfd2" to { skinTone -> getNonSkinToneEmoji(skinTone, Hockey) },
            "\ud83c\udfd1" to { skinTone -> getNonSkinToneEmoji(skinTone, FieldHockey) },
            "\ud83c\udfcf" to { skinTone -> getNonSkinToneEmoji(skinTone, Cricket) },
            "\ud83c\udfbf" to { skinTone -> getNonSkinToneEmoji(skinTone, Ski) },
            "\u26f7" to { skinTone -> getNonSkinToneEmoji(skinTone, Skier) },
            "\ud83c\udfc2" to { skinTone -> getNonSkinToneEmoji(skinTone, Snowboarder) },
            "\u26f8" to { skinTone -> getNonSkinToneEmoji(skinTone, IceSkate) },
            "\ud83c\udff9" to { skinTone -> getNonSkinToneEmoji(skinTone, BowAndArrow) },
            "\ud83c\udfa3" to { skinTone -> getNonSkinToneEmoji(skinTone, FishingPoleAndFish) },
            "\ud83d\udea3" to { skinTone -> getNonSkinToneEmoji(skinTone, Rowboat) },
            "\ud83c\udfca" to { skinTone -> getNonSkinToneEmoji(skinTone, Swimmer) },
            "\ud83c\udfc4" to { skinTone -> getNonSkinToneEmoji(skinTone, Surfer) },
            "\ud83d\udec0" to { skinTone -> getNonSkinToneEmoji(skinTone, Bath) },
            "\u26f9" to { skinTone -> getNonSkinToneEmoji(skinTone, BasketballPlayer) },
            "\ud83c\udfcb" to { skinTone -> getNonSkinToneEmoji(skinTone, Lifter) },
            "\ud83d\udeb4" to { skinTone -> getNonSkinToneEmoji(skinTone, Bicyclist) },
            "\ud83d\udeb5" to { skinTone -> getNonSkinToneEmoji(skinTone, MountainBicyclist) },
            "\ud83c\udfc7" to { skinTone -> getNonSkinToneEmoji(skinTone, HorseRacing) },
            "\ud83d\udd74" to { skinTone -> getNonSkinToneEmoji(skinTone, Levitate) },
            "\ud83c\udfc6" to { skinTone -> getNonSkinToneEmoji(skinTone, Trophy) },
            "\ud83c\udfbd" to { skinTone -> getNonSkinToneEmoji(skinTone, RunningShirtWithSash) },
            "\ud83c\udfc5" to { skinTone -> getNonSkinToneEmoji(skinTone, Medal) },
            "\ud83c\udf96" to { skinTone -> getNonSkinToneEmoji(skinTone, MilitaryMedal) },
            "\ud83c\udf97" to { skinTone -> getNonSkinToneEmoji(skinTone, ReminderRibbon) },
            "\ud83c\udff5" to { skinTone -> getNonSkinToneEmoji(skinTone, Rosette) },
            "\ud83c\udfab" to { skinTone -> getNonSkinToneEmoji(skinTone, Ticket) },
            "\ud83c\udf9f" to { skinTone -> getNonSkinToneEmoji(skinTone, Tickets) },
            "\ud83c\udfad" to { skinTone -> getNonSkinToneEmoji(skinTone, PerformingArts) },
            "\ud83c\udfa8" to { skinTone -> getNonSkinToneEmoji(skinTone, Art) },
            "\ud83c\udfaa" to { skinTone -> getNonSkinToneEmoji(skinTone, CircusTent) },
            "\ud83c\udfa4" to { skinTone -> getNonSkinToneEmoji(skinTone, Microphone) },
            "\ud83c\udfa7" to { skinTone -> getNonSkinToneEmoji(skinTone, Headphones) },
            "\ud83c\udfbc" to { skinTone -> getNonSkinToneEmoji(skinTone, MusicalScore) },
            "\ud83c\udfb9" to { skinTone -> getNonSkinToneEmoji(skinTone, MusicalKeyboard) },
            "\ud83c\udfb7" to { skinTone -> getNonSkinToneEmoji(skinTone, Saxophone) },
            "\ud83c\udfba" to { skinTone -> getNonSkinToneEmoji(skinTone, Trumpet) },
            "\ud83c\udfb8" to { skinTone -> getNonSkinToneEmoji(skinTone, Guitar) },
            "\ud83c\udfbb" to { skinTone -> getNonSkinToneEmoji(skinTone, Violin) },
            "\ud83c\udfac" to { skinTone -> getNonSkinToneEmoji(skinTone, Clapper) },
            "\ud83c\udfae" to { skinTone -> getNonSkinToneEmoji(skinTone, VideoGame) },
            "\ud83d\udc7e" to { skinTone -> getNonSkinToneEmoji(skinTone, SpaceInvader) },
            "\ud83c\udfaf" to { skinTone -> getNonSkinToneEmoji(skinTone, Dart) },
            "\ud83c\udfb2" to { skinTone -> getNonSkinToneEmoji(skinTone, GameDie) },
            "\ud83c\udfb0" to { skinTone -> getNonSkinToneEmoji(skinTone, SlotMachine) },
            "\ud83c\udfb3" to { skinTone -> getNonSkinToneEmoji(skinTone, Bowling) },
            "\ud83e\udd38" to { skinTone -> getNonSkinToneEmoji(skinTone, Cartwheel) },
            "\ud83e\udd39" to { skinTone -> getNonSkinToneEmoji(skinTone, Juggling) },
            "\ud83e\udd3c" to { skinTone -> getNonSkinToneEmoji(skinTone, Wrestlers) },
            "\ud83e\udd4a" to { skinTone -> getNonSkinToneEmoji(skinTone, BoxingGlove) },
            "\ud83e\udd4b" to { skinTone -> getNonSkinToneEmoji(skinTone, MartialArtsUniform) },
            "\ud83e\udd3d" to { skinTone -> getNonSkinToneEmoji(skinTone, WaterPolo) },
            "\ud83e\udd3e" to { skinTone -> getNonSkinToneEmoji(skinTone, Handball) },
            "\ud83e\udd45" to { skinTone -> getNonSkinToneEmoji(skinTone, Goal) },
            "\ud83e\udd3a" to { skinTone -> getNonSkinToneEmoji(skinTone, Fencer) },
            "\ud83e\udd47" to { skinTone -> getNonSkinToneEmoji(skinTone, FirstPlace) },
            "\ud83e\udd48" to { skinTone -> getNonSkinToneEmoji(skinTone, SecondPlace) },
            "\ud83e\udd49" to { skinTone -> getNonSkinToneEmoji(skinTone, ThirdPlace) },
            "\ud83e\udd41" to { skinTone -> getNonSkinToneEmoji(skinTone, Drum) },
            "\ud83d\ude97" to { skinTone -> getNonSkinToneEmoji(skinTone, Car) },
            "\ud83d\ude95" to { skinTone -> getNonSkinToneEmoji(skinTone, Taxi) },
            "\ud83d\ude99" to { skinTone -> getNonSkinToneEmoji(skinTone, BlueCar) },
            "\ud83d\ude8c" to { skinTone -> getNonSkinToneEmoji(skinTone, Bus) },
            "\ud83d\ude8e" to { skinTone -> getNonSkinToneEmoji(skinTone, Trolleybus) },
            "\ud83c\udfce" to { skinTone -> getNonSkinToneEmoji(skinTone, RaceCar) },
            "\ud83d\ude93" to { skinTone -> getNonSkinToneEmoji(skinTone, PoliceCar) },
            "\ud83d\ude91" to { skinTone -> getNonSkinToneEmoji(skinTone, Ambulance) },
            "\ud83d\ude92" to { skinTone -> getNonSkinToneEmoji(skinTone, FireEngine) },
            "\ud83d\ude90" to { skinTone -> getNonSkinToneEmoji(skinTone, Minibus) },
            "\ud83d\ude9a" to { skinTone -> getNonSkinToneEmoji(skinTone, Truck) },
            "\ud83d\ude9b" to { skinTone -> getNonSkinToneEmoji(skinTone, ArticulatedLorry) },
            "\ud83d\ude9c" to { skinTone -> getNonSkinToneEmoji(skinTone, Tractor) },
            "\ud83c\udfcd" to { skinTone -> getNonSkinToneEmoji(skinTone, Motorcycle) },
            "\ud83d\udeb2" to { skinTone -> getNonSkinToneEmoji(skinTone, Bike) },
            "\ud83d\udea8" to { skinTone -> getNonSkinToneEmoji(skinTone, RotatingLight) },
            "\ud83d\ude94" to { skinTone -> getNonSkinToneEmoji(skinTone, OncomingPoliceCar) },
            "\ud83d\ude8d" to { skinTone -> getNonSkinToneEmoji(skinTone, OncomingBus) },
            "\ud83d\ude98" to { skinTone -> getNonSkinToneEmoji(skinTone, OncomingAutomobile) },
            "\ud83d\ude96" to { skinTone -> getNonSkinToneEmoji(skinTone, OncomingTaxi) },
            "\ud83d\udea1" to { skinTone -> getNonSkinToneEmoji(skinTone, AerialTramway) },
            "\ud83d\udea0" to { skinTone -> getNonSkinToneEmoji(skinTone, MountainCableway) },
            "\ud83d\ude9f" to { skinTone -> getNonSkinToneEmoji(skinTone, SuspensionRailway) },
            "\ud83d\ude83" to { skinTone -> getNonSkinToneEmoji(skinTone, RailwayCar) },
            "\ud83d\ude8b" to { skinTone -> getNonSkinToneEmoji(skinTone, Train) },
            "\ud83d\ude9d" to { skinTone -> getNonSkinToneEmoji(skinTone, Monorail) },
            "\ud83d\ude84" to { skinTone -> getNonSkinToneEmoji(skinTone, BullettrainSide) },
            "\ud83d\ude85" to { skinTone -> getNonSkinToneEmoji(skinTone, BullettrainFront) },
            "\ud83d\ude88" to { skinTone -> getNonSkinToneEmoji(skinTone, LightRail) },
            "\ud83d\ude9e" to { skinTone -> getNonSkinToneEmoji(skinTone, MountainRailway) },
            "\ud83d\ude82" to { skinTone -> getNonSkinToneEmoji(skinTone, SteamLocomotive) },
            "\ud83d\ude86" to { skinTone -> getNonSkinToneEmoji(skinTone, Train2) },
            "\ud83d\ude87" to { skinTone -> getNonSkinToneEmoji(skinTone, Metro) },
            "\ud83d\ude8a" to { skinTone -> getNonSkinToneEmoji(skinTone, Tram) },
            "\ud83d\ude89" to { skinTone -> getNonSkinToneEmoji(skinTone, Station) },
            "\ud83d\ude81" to { skinTone -> getNonSkinToneEmoji(skinTone, Helicopter) },
            "\ud83d\udee9" to { skinTone -> getNonSkinToneEmoji(skinTone, AirplaneSmall) },
            "\u2708" to { skinTone -> getNonSkinToneEmoji(skinTone, Airplane) },
            "\ud83d\udeeb" to { skinTone -> getNonSkinToneEmoji(skinTone, AirplaneDeparture) },
            "\ud83d\udeec" to { skinTone -> getNonSkinToneEmoji(skinTone, AirplaneArriving) },
            "\u26f5" to { skinTone -> getNonSkinToneEmoji(skinTone, Sailboat) },
            "\ud83d\udee5" to { skinTone -> getNonSkinToneEmoji(skinTone, Motorboat) },
            "\ud83d\udea4" to { skinTone -> getNonSkinToneEmoji(skinTone, Speedboat) },
            "\u26f4" to { skinTone -> getNonSkinToneEmoji(skinTone, Ferry) },
            "\ud83d\udef3" to { skinTone -> getNonSkinToneEmoji(skinTone, CruiseShip) },
            "\ud83d\ude80" to { skinTone -> getNonSkinToneEmoji(skinTone, Rocket) },
            "\ud83d\udef0" to { skinTone -> getNonSkinToneEmoji(skinTone, SatelliteOrbital) },
            "\ud83d\udcba" to { skinTone -> getNonSkinToneEmoji(skinTone, Seat) },
            "\u2693" to { skinTone -> getNonSkinToneEmoji(skinTone, Anchor) },
            "\ud83d\udea7" to { skinTone -> getNonSkinToneEmoji(skinTone, Construction) },
            "\u26fd" to { skinTone -> getNonSkinToneEmoji(skinTone, Fuelpump) },
            "\ud83d\ude8f" to { skinTone -> getNonSkinToneEmoji(skinTone, Busstop) },
            "\ud83d\udea6" to { skinTone -> getNonSkinToneEmoji(skinTone, VerticalTrafficLight) },
            "\ud83d\udea5" to { skinTone -> getNonSkinToneEmoji(skinTone, TrafficLight) },
            "\ud83c\udfc1" to { skinTone -> getNonSkinToneEmoji(skinTone, CheckeredFlag) },
            "\ud83d\udea2" to { skinTone -> getNonSkinToneEmoji(skinTone, Ship) },
            "\ud83c\udfa1" to { skinTone -> getNonSkinToneEmoji(skinTone, FerrisWheel) },
            "\ud83c\udfa2" to { skinTone -> getNonSkinToneEmoji(skinTone, RollerCoaster) },
            "\ud83c\udfa0" to { skinTone -> getNonSkinToneEmoji(skinTone, CarouselHorse) },
            "\ud83c\udfd7" to { skinTone -> getNonSkinToneEmoji(skinTone, ConstructionSite) },
            "\ud83c\udf01" to { skinTone -> getNonSkinToneEmoji(skinTone, Foggy) },
            "\ud83d\uddfc" to { skinTone -> getNonSkinToneEmoji(skinTone, TokyoTower) },
            "\ud83c\udfed" to { skinTone -> getNonSkinToneEmoji(skinTone, Factory) },
            "\u26f2" to { skinTone -> getNonSkinToneEmoji(skinTone, Fountain) },
            "\ud83c\udf91" to { skinTone -> getNonSkinToneEmoji(skinTone, RiceScene) },
            "\u26f0" to { skinTone -> getNonSkinToneEmoji(skinTone, Mountain) },
            "\ud83c\udfd4" to { skinTone -> getNonSkinToneEmoji(skinTone, MountainSnow) },
            "\ud83d\uddfb" to { skinTone -> getNonSkinToneEmoji(skinTone, MountFuji) },
            "\ud83c\udf0b" to { skinTone -> getNonSkinToneEmoji(skinTone, Volcano) },
            "\ud83d\uddfe" to { skinTone -> getNonSkinToneEmoji(skinTone, Japan) },
            "\ud83c\udfd5" to { skinTone -> getNonSkinToneEmoji(skinTone, Camping) },
            "\u26fa" to { skinTone -> getNonSkinToneEmoji(skinTone, Tent) },
            "\ud83c\udfde" to { skinTone -> getNonSkinToneEmoji(skinTone, Park) },
            "\ud83d\udee3" to { skinTone -> getNonSkinToneEmoji(skinTone, Motorway) },
            "\ud83d\udee4" to { skinTone -> getNonSkinToneEmoji(skinTone, RailwayTrack) },
            "\ud83c\udf05" to { skinTone -> getNonSkinToneEmoji(skinTone, Sunrise) },
            "\ud83c\udf04" to { skinTone -> getNonSkinToneEmoji(skinTone, SunriseOverMountains) },
            "\ud83c\udfdc" to { skinTone -> getNonSkinToneEmoji(skinTone, Desert) },
            "\ud83c\udfd6" to { skinTone -> getNonSkinToneEmoji(skinTone, Beach) },
            "\ud83c\udfdd" to { skinTone -> getNonSkinToneEmoji(skinTone, Island) },
            "\ud83c\udf07" to { skinTone -> getNonSkinToneEmoji(skinTone, CitySunrise) },
            "\ud83c\udf06" to { skinTone -> getNonSkinToneEmoji(skinTone, CityDusk) },
            "\ud83c\udfd9" to { skinTone -> getNonSkinToneEmoji(skinTone, Cityscape) },
            "\ud83c\udf03" to { skinTone -> getNonSkinToneEmoji(skinTone, NightWithStars) },
            "\ud83c\udf09" to { skinTone -> getNonSkinToneEmoji(skinTone, BridgeAtNight) },
            "\ud83c\udf0c" to { skinTone -> getNonSkinToneEmoji(skinTone, MilkyWay) },
            "\ud83c\udf20" to { skinTone -> getNonSkinToneEmoji(skinTone, Stars) },
            "\ud83c\udf87" to { skinTone -> getNonSkinToneEmoji(skinTone, Sparkler) },
            "\ud83c\udf86" to { skinTone -> getNonSkinToneEmoji(skinTone, Fireworks) },
            "\ud83c\udf08" to { skinTone -> getNonSkinToneEmoji(skinTone, Rainbow) },
            "\ud83c\udfd8" to { skinTone -> getNonSkinToneEmoji(skinTone, Homes) },
            "\ud83c\udff0" to { skinTone -> getNonSkinToneEmoji(skinTone, EuropeanCastle) },
            "\ud83c\udfef" to { skinTone -> getNonSkinToneEmoji(skinTone, JapaneseCastle) },
            "\ud83c\udfdf" to { skinTone -> getNonSkinToneEmoji(skinTone, Stadium) },
            "\ud83d\uddfd" to { skinTone -> getNonSkinToneEmoji(skinTone, StatueOfLiberty) },
            "\ud83c\udfe0" to { skinTone -> getNonSkinToneEmoji(skinTone, House) },
            "\ud83c\udfe1" to { skinTone -> getNonSkinToneEmoji(skinTone, HouseWithGarden) },
            "\ud83c\udfda" to { skinTone -> getNonSkinToneEmoji(skinTone, HouseAbandoned) },
            "\ud83c\udfe2" to { skinTone -> getNonSkinToneEmoji(skinTone, Office) },
            "\ud83c\udfec" to { skinTone -> getNonSkinToneEmoji(skinTone, DepartmentStore) },
            "\ud83c\udfe3" to { skinTone -> getNonSkinToneEmoji(skinTone, PostOffice) },
            "\ud83c\udfe4" to { skinTone -> getNonSkinToneEmoji(skinTone, EuropeanPostOffice) },
            "\ud83c\udfe5" to { skinTone -> getNonSkinToneEmoji(skinTone, Hospital) },
            "\ud83c\udfe6" to { skinTone -> getNonSkinToneEmoji(skinTone, Bank) },
            "\ud83c\udfe8" to { skinTone -> getNonSkinToneEmoji(skinTone, Hotel) },
            "\ud83c\udfea" to { skinTone -> getNonSkinToneEmoji(skinTone, ConvenienceStore) },
            "\ud83c\udfeb" to { skinTone -> getNonSkinToneEmoji(skinTone, School) },
            "\ud83c\udfe9" to { skinTone -> getNonSkinToneEmoji(skinTone, LoveHotel) },
            "\ud83d\udc92" to { skinTone -> getNonSkinToneEmoji(skinTone, Wedding) },
            "\ud83c\udfdb" to { skinTone -> getNonSkinToneEmoji(skinTone, ClassicalBuilding) },
            "\u26ea" to { skinTone -> getNonSkinToneEmoji(skinTone, Church) },
            "\ud83d\udd4c" to { skinTone -> getNonSkinToneEmoji(skinTone, Mosque) },
            "\ud83d\udd4d" to { skinTone -> getNonSkinToneEmoji(skinTone, Synagogue) },
            "\ud83d\udd4b" to { skinTone -> getNonSkinToneEmoji(skinTone, Kaaba) },
            "\u26e9" to { skinTone -> getNonSkinToneEmoji(skinTone, ShintoShrine) },
            "\ud83d\udef4" to { skinTone -> getNonSkinToneEmoji(skinTone, Scooter) },
            "\ud83d\udef5" to { skinTone -> getNonSkinToneEmoji(skinTone, Motorbike) },
            "\ud83d\udef6" to { skinTone -> getNonSkinToneEmoji(skinTone, Canoe) },
            "\u231a" to { skinTone -> getNonSkinToneEmoji(skinTone, Watch) },
            "\ud83d\udcf1" to { skinTone -> getNonSkinToneEmoji(skinTone, Iphone) },
            "\ud83d\udcf2" to { skinTone -> getNonSkinToneEmoji(skinTone, Calling) },
            "\ud83d\udcbb" to { skinTone -> getNonSkinToneEmoji(skinTone, Computer) },
            "\u2328" to { skinTone -> getNonSkinToneEmoji(skinTone, Keyboard) },
            "\ud83d\udda5" to { skinTone -> getNonSkinToneEmoji(skinTone, Desktop) },
            "\ud83d\udda8" to { skinTone -> getNonSkinToneEmoji(skinTone, Printer) },
            "\ud83d\uddb1" to { skinTone -> getNonSkinToneEmoji(skinTone, MouseThreeButton) },
            "\ud83d\uddb2" to { skinTone -> getNonSkinToneEmoji(skinTone, Trackball) },
            "\ud83d\udd79" to { skinTone -> getNonSkinToneEmoji(skinTone, Joystick) },
            "\ud83d\udddc" to { skinTone -> getNonSkinToneEmoji(skinTone, Compression) },
            "\ud83d\udcbd" to { skinTone -> getNonSkinToneEmoji(skinTone, Minidisc) },
            "\ud83d\udcbe" to { skinTone -> getNonSkinToneEmoji(skinTone, FloppyDisk) },
            "\ud83d\udcbf" to { skinTone -> getNonSkinToneEmoji(skinTone, CD) },
            "\ud83d\udcc0" to { skinTone -> getNonSkinToneEmoji(skinTone, Dvd) },
            "\ud83d\udcfc" to { skinTone -> getNonSkinToneEmoji(skinTone, Vhs) },
            "\ud83d\udcf7" to { skinTone -> getNonSkinToneEmoji(skinTone, Camera) },
            "\ud83d\udcf8" to { skinTone -> getNonSkinToneEmoji(skinTone, CameraWithFlash) },
            "\ud83d\udcf9" to { skinTone -> getNonSkinToneEmoji(skinTone, VideoCamera) },
            "\ud83c\udfa5" to { skinTone -> getNonSkinToneEmoji(skinTone, MovieCamera) },
            "\ud83d\udcfd" to { skinTone -> getNonSkinToneEmoji(skinTone, Projector) },
            "\ud83c\udf9e" to { skinTone -> getNonSkinToneEmoji(skinTone, FilmFrames) },
            "\ud83d\udcde" to { skinTone -> getNonSkinToneEmoji(skinTone, TelephoneReceiver) },
            "\u260e" to { skinTone -> getNonSkinToneEmoji(skinTone, Telephone) },
            "\ud83d\udcdf" to { skinTone -> getNonSkinToneEmoji(skinTone, Pager) },
            "\ud83d\udce0" to { skinTone -> getNonSkinToneEmoji(skinTone, Fax) },
            "\ud83d\udcfa" to { skinTone -> getNonSkinToneEmoji(skinTone, TV) },
            "\ud83d\udcfb" to { skinTone -> getNonSkinToneEmoji(skinTone, Radio) },
            "\ud83c\udf99" to { skinTone -> getNonSkinToneEmoji(skinTone, Microphone2) },
            "\ud83c\udf9a" to { skinTone -> getNonSkinToneEmoji(skinTone, LevelSlider) },
            "\ud83c\udf9b" to { skinTone -> getNonSkinToneEmoji(skinTone, ControlKnobs) },
            "\u23f1" to { skinTone -> getNonSkinToneEmoji(skinTone, Stopwatch) },
            "\u23f2" to { skinTone -> getNonSkinToneEmoji(skinTone, Timer) },
            "\u23f0" to { skinTone -> getNonSkinToneEmoji(skinTone, AlarmClock) },
            "\ud83d\udd70" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock) },
            "\u23f3" to { skinTone -> getNonSkinToneEmoji(skinTone, HourglassFlowingSand) },
            "\u231b" to { skinTone -> getNonSkinToneEmoji(skinTone, Hourglass) },
            "\ud83d\udce1" to { skinTone -> getNonSkinToneEmoji(skinTone, Satellite) },
            "\ud83d\udd0b" to { skinTone -> getNonSkinToneEmoji(skinTone, Battery) },
            "\ud83d\udd0c" to { skinTone -> getNonSkinToneEmoji(skinTone, ElectricPlug) },
            "\ud83d\udca1" to { skinTone -> getNonSkinToneEmoji(skinTone, Bulb) },
            "\ud83d\udd26" to { skinTone -> getNonSkinToneEmoji(skinTone, Flashlight) },
            "\ud83d\udd6f" to { skinTone -> getNonSkinToneEmoji(skinTone, Candle) },
            "\ud83d\uddd1" to { skinTone -> getNonSkinToneEmoji(skinTone, Wastebasket) },
            "\ud83d\udee2" to { skinTone -> getNonSkinToneEmoji(skinTone, Oil) },
            "\ud83d\udcb8" to { skinTone -> getNonSkinToneEmoji(skinTone, MoneyWithWings) },
            "\ud83d\udcb5" to { skinTone -> getNonSkinToneEmoji(skinTone, Dollar) },
            "\ud83d\udcb4" to { skinTone -> getNonSkinToneEmoji(skinTone, Yen) },
            "\ud83d\udcb6" to { skinTone -> getNonSkinToneEmoji(skinTone, Euro) },
            "\ud83d\udcb7" to { skinTone -> getNonSkinToneEmoji(skinTone, Pound) },
            "\ud83d\udcb0" to { skinTone -> getNonSkinToneEmoji(skinTone, Moneybag) },
            "\ud83d\udcb3" to { skinTone -> getNonSkinToneEmoji(skinTone, CreditCard) },
            "\ud83d\udc8e" to { skinTone -> getNonSkinToneEmoji(skinTone, Gem) },
            "\u2696" to { skinTone -> getNonSkinToneEmoji(skinTone, Scales) },
            "\ud83d\udd27" to { skinTone -> getNonSkinToneEmoji(skinTone, Wrench) },
            "\ud83d\udd28" to { skinTone -> getNonSkinToneEmoji(skinTone, Hammer) },
            "\u2692" to { skinTone -> getNonSkinToneEmoji(skinTone, HammerPick) },
            "\ud83d\udee0" to { skinTone -> getNonSkinToneEmoji(skinTone, Tools) },
            "\u26cf" to { skinTone -> getNonSkinToneEmoji(skinTone, Pick) },
            "\ud83d\udd29" to { skinTone -> getNonSkinToneEmoji(skinTone, NutAndBolt) },
            "\u2699" to { skinTone -> getNonSkinToneEmoji(skinTone, Gear) },
            "\u26d3" to { skinTone -> getNonSkinToneEmoji(skinTone, Chains) },
            "\ud83d\udd2b" to { skinTone -> getNonSkinToneEmoji(skinTone, Gun) },
            "\ud83d\udca3" to { skinTone -> getNonSkinToneEmoji(skinTone, Bomb) },
            "\ud83d\udd2a" to { skinTone -> getNonSkinToneEmoji(skinTone, Knife) },
            "\ud83d\udde1" to { skinTone -> getNonSkinToneEmoji(skinTone, Dagger) },
            "\u2694" to { skinTone -> getNonSkinToneEmoji(skinTone, CrossedSwords) },
            "\ud83d\udee1" to { skinTone -> getNonSkinToneEmoji(skinTone, Shield) },
            "\ud83d\udeac" to { skinTone -> getNonSkinToneEmoji(skinTone, Smoking) },
            "\u2620" to { skinTone -> getNonSkinToneEmoji(skinTone, SkullCrossbones) },
            "\u26b0" to { skinTone -> getNonSkinToneEmoji(skinTone, Coffin) },
            "\u26b1" to { skinTone -> getNonSkinToneEmoji(skinTone, Urn) },
            "\ud83c\udffa" to { skinTone -> getNonSkinToneEmoji(skinTone, Amphora) },
            "\ud83d\udd2e" to { skinTone -> getNonSkinToneEmoji(skinTone, CrystalBall) },
            "\ud83d\udcff" to { skinTone -> getNonSkinToneEmoji(skinTone, PrayerBeads) },
            "\ud83d\udc88" to { skinTone -> getNonSkinToneEmoji(skinTone, Barber) },
            "\u2697" to { skinTone -> getNonSkinToneEmoji(skinTone, Alembic) },
            "\ud83d\udd2d" to { skinTone -> getNonSkinToneEmoji(skinTone, Telescope) },
            "\ud83d\udd2c" to { skinTone -> getNonSkinToneEmoji(skinTone, Microscope) },
            "\ud83d\udd73" to { skinTone -> getNonSkinToneEmoji(skinTone, Hole) },
            "\ud83d\udc8a" to { skinTone -> getNonSkinToneEmoji(skinTone, Pill) },
            "\ud83d\udc89" to { skinTone -> getNonSkinToneEmoji(skinTone, Syringe) },
            "\ud83c\udf21" to { skinTone -> getNonSkinToneEmoji(skinTone, Thermometer) },
            "\ud83c\udff7" to { skinTone -> getNonSkinToneEmoji(skinTone, Label) },
            "\ud83d\udd16" to { skinTone -> getNonSkinToneEmoji(skinTone, Bookmark) },
            "\ud83d\udebd" to { skinTone -> getNonSkinToneEmoji(skinTone, Toilet) },
            "\ud83d\udebf" to { skinTone -> getNonSkinToneEmoji(skinTone, Shower) },
            "\ud83d\udec1" to { skinTone -> getNonSkinToneEmoji(skinTone, Bathtub) },
            "\ud83d\udd11" to { skinTone -> getNonSkinToneEmoji(skinTone, Key) },
            "\ud83d\udddd" to { skinTone -> getNonSkinToneEmoji(skinTone, Key2) },
            "\ud83d\udecb" to { skinTone -> getNonSkinToneEmoji(skinTone, Couch) },
            "\ud83d\udecc" to { skinTone -> getNonSkinToneEmoji(skinTone, SleepingAccommodation) },
            "\ud83d\udecf" to { skinTone -> getNonSkinToneEmoji(skinTone, Bed) },
            "\ud83d\udeaa" to { skinTone -> getNonSkinToneEmoji(skinTone, Door) },
            "\ud83d\udece" to { skinTone -> getNonSkinToneEmoji(skinTone, Bellhop) },
            "\ud83d\uddbc" to { skinTone -> getNonSkinToneEmoji(skinTone, FramePhoto) },
            "\ud83d\uddfa" to { skinTone -> getNonSkinToneEmoji(skinTone, Map) },
            "\u26f1" to { skinTone -> getNonSkinToneEmoji(skinTone, BeachUmbrella) },
            "\ud83d\uddff" to { skinTone -> getNonSkinToneEmoji(skinTone, Moyai) },
            "\ud83d\udecd" to { skinTone -> getNonSkinToneEmoji(skinTone, ShoppingBags) },
            "\ud83c\udf88" to { skinTone -> getNonSkinToneEmoji(skinTone, Balloon) },
            "\ud83c\udf8f" to { skinTone -> getNonSkinToneEmoji(skinTone, Flags) },
            "\ud83c\udf80" to { skinTone -> getNonSkinToneEmoji(skinTone, Ribbon) },
            "\ud83c\udf81" to { skinTone -> getNonSkinToneEmoji(skinTone, Gift) },
            "\ud83c\udf8a" to { skinTone -> getNonSkinToneEmoji(skinTone, ConfettiBall) },
            "\ud83c\udf89" to { skinTone -> getNonSkinToneEmoji(skinTone, Tada) },
            "\ud83c\udf8e" to { skinTone -> getNonSkinToneEmoji(skinTone, Dolls) },
            "\ud83c\udf90" to { skinTone -> getNonSkinToneEmoji(skinTone, WindChime) },
            "\ud83c\udf8c" to { skinTone -> getNonSkinToneEmoji(skinTone, CrossedFlags) },
            "\ud83c\udfee" to { skinTone -> getNonSkinToneEmoji(skinTone, Lantern) },
            "\u2709" to { skinTone -> getNonSkinToneEmoji(skinTone, Envelope) },
            "\ud83d\udce7" to { skinTone -> getNonSkinToneEmoji(skinTone, Email) },
            "\ud83d\udce9" to { skinTone -> getNonSkinToneEmoji(skinTone, EnvelopeWithArrow) },
            "\ud83d\udce8" to { skinTone -> getNonSkinToneEmoji(skinTone, IncomingEnvelope) },
            "\ud83d\udc8c" to { skinTone -> getNonSkinToneEmoji(skinTone, LoveLetter) },
            "\ud83d\udcee" to { skinTone -> getNonSkinToneEmoji(skinTone, Postbox) },
            "\ud83d\udcea" to { skinTone -> getNonSkinToneEmoji(skinTone, MailboxClosed) },
            "\ud83d\udceb" to { skinTone -> getNonSkinToneEmoji(skinTone, Mailbox) },
            "\ud83d\udcec" to { skinTone -> getNonSkinToneEmoji(skinTone, MailboxWithMail) },
            "\ud83d\udced" to { skinTone -> getNonSkinToneEmoji(skinTone, MailboxWithNoMail) },
            "\ud83d\udce6" to { skinTone -> getNonSkinToneEmoji(skinTone, Package) },
            "\ud83d\udcef" to { skinTone -> getNonSkinToneEmoji(skinTone, PostalHorn) },
            "\ud83d\udce5" to { skinTone -> getNonSkinToneEmoji(skinTone, InboxTray) },
            "\ud83d\udce4" to { skinTone -> getNonSkinToneEmoji(skinTone, OutboxTray) },
            "\ud83d\udcdc" to { skinTone -> getNonSkinToneEmoji(skinTone, Scroll) },
            "\ud83d\udcc3" to { skinTone -> getNonSkinToneEmoji(skinTone, PageWithCurl) },
            "\ud83d\udcd1" to { skinTone -> getNonSkinToneEmoji(skinTone, BookmarkTabs) },
            "\ud83d\udcca" to { skinTone -> getNonSkinToneEmoji(skinTone, BarChart) },
            "\ud83d\udcc8" to { skinTone -> getNonSkinToneEmoji(skinTone, ChartWithUpwardsTrend) },
            "\ud83d\udcc9" to { skinTone -> getNonSkinToneEmoji(skinTone, ChartWithDownwardsTrend) },
            "\ud83d\udcc4" to { skinTone -> getNonSkinToneEmoji(skinTone, PageFacingUp) },
            "\ud83d\udcc5" to { skinTone -> getNonSkinToneEmoji(skinTone, Date) },
            "\ud83d\udcc6" to { skinTone -> getNonSkinToneEmoji(skinTone, Calendar) },
            "\ud83d\uddd3" to { skinTone -> getNonSkinToneEmoji(skinTone, CalendarSpiral) },
            "\ud83d\udcc7" to { skinTone -> getNonSkinToneEmoji(skinTone, CardIndex) },
            "\ud83d\uddc3" to { skinTone -> getNonSkinToneEmoji(skinTone, CardBox) },
            "\ud83d\uddf3" to { skinTone -> getNonSkinToneEmoji(skinTone, BallotBox) },
            "\ud83d\uddc4" to { skinTone -> getNonSkinToneEmoji(skinTone, FileCabinet) },
            "\ud83d\udccb" to { skinTone -> getNonSkinToneEmoji(skinTone, Clipboard) },
            "\ud83d\uddd2" to { skinTone -> getNonSkinToneEmoji(skinTone, NotepadSpiral) },
            "\ud83d\udcc1" to { skinTone -> getNonSkinToneEmoji(skinTone, FileFolder) },
            "\ud83d\udcc2" to { skinTone -> getNonSkinToneEmoji(skinTone, OpenFileFolder) },
            "\ud83d\uddc2" to { skinTone -> getNonSkinToneEmoji(skinTone, Dividers) },
            "\ud83d\uddde" to { skinTone -> getNonSkinToneEmoji(skinTone, Newspaper2) },
            "\ud83d\udcf0" to { skinTone -> getNonSkinToneEmoji(skinTone, Newspaper) },
            "\ud83d\udcd3" to { skinTone -> getNonSkinToneEmoji(skinTone, Notebook) },
            "\ud83d\udcd5" to { skinTone -> getNonSkinToneEmoji(skinTone, ClosedBook) },
            "\ud83d\udcd7" to { skinTone -> getNonSkinToneEmoji(skinTone, GreenBook) },
            "\ud83d\udcd8" to { skinTone -> getNonSkinToneEmoji(skinTone, BlueBook) },
            "\ud83d\udcd9" to { skinTone -> getNonSkinToneEmoji(skinTone, OrangeBook) },
            "\ud83d\udcd4" to { skinTone -> getNonSkinToneEmoji(skinTone, NotebookWithDecorativeCover) },
            "\ud83d\udcd2" to { skinTone -> getNonSkinToneEmoji(skinTone, Ledger) },
            "\ud83d\udcda" to { skinTone -> getNonSkinToneEmoji(skinTone, Books) },
            "\ud83d\udcd6" to { skinTone -> getNonSkinToneEmoji(skinTone, Book) },
            "\ud83d\udd17" to { skinTone -> getNonSkinToneEmoji(skinTone, Link) },
            "\ud83d\udcce" to { skinTone -> getNonSkinToneEmoji(skinTone, Paperclip) },
            "\ud83d\udd87" to { skinTone -> getNonSkinToneEmoji(skinTone, Paperclips) },
            "\u2702" to { skinTone -> getNonSkinToneEmoji(skinTone, Scissors) },
            "\ud83d\udcd0" to { skinTone -> getNonSkinToneEmoji(skinTone, TriangularRuler) },
            "\ud83d\udccf" to { skinTone -> getNonSkinToneEmoji(skinTone, StraightRuler) },
            "\ud83d\udccc" to { skinTone -> getNonSkinToneEmoji(skinTone, Pushpin) },
            "\ud83d\udccd" to { skinTone -> getNonSkinToneEmoji(skinTone, RoundPushpin) },
            "\ud83d\udea9" to { skinTone -> getNonSkinToneEmoji(skinTone, TriangularFlagOnPost) },
            "\ud83c\udff3" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagWhite) },
            "\ud83c\udff4" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBlack) },
            "\ud83d\udd10" to { skinTone -> getNonSkinToneEmoji(skinTone, ClosedLockWithKey) },
            "\ud83d\udd12" to { skinTone -> getNonSkinToneEmoji(skinTone, Lock) },
            "\ud83d\udd13" to { skinTone -> getNonSkinToneEmoji(skinTone, Unlock) },
            "\ud83d\udd0f" to { skinTone -> getNonSkinToneEmoji(skinTone, LockWithInkPen) },
            "\ud83d\udd8a" to { skinTone -> getNonSkinToneEmoji(skinTone, PenBallpoint) },
            "\ud83d\udd8b" to { skinTone -> getNonSkinToneEmoji(skinTone, PenFountain) },
            "\u2712" to { skinTone -> getNonSkinToneEmoji(skinTone, BlackNib) },
            "\ud83d\udcdd" to { skinTone -> getNonSkinToneEmoji(skinTone, Memo) },
            "\u270f" to { skinTone -> getNonSkinToneEmoji(skinTone, Pencil2) },
            "\ud83d\udd8d" to { skinTone -> getNonSkinToneEmoji(skinTone, Crayon) },
            "\ud83d\udd8c" to { skinTone -> getNonSkinToneEmoji(skinTone, Paintbrush) },
            "\ud83d\udd0d" to { skinTone -> getNonSkinToneEmoji(skinTone, Mag) },
            "\ud83d\udd0e" to { skinTone -> getNonSkinToneEmoji(skinTone, MagRight) },
            "\ud83d\uded2" to { skinTone -> getNonSkinToneEmoji(skinTone, ShoppingCart) },
            "\ud83d\udcaf" to { skinTone -> getNonSkinToneEmoji(skinTone, OneHundred) },
            "\ud83d\udd22" to { skinTone -> getNonSkinToneEmoji(skinTone, OneTwoThreeFour) },
            "\u2764" to { skinTone -> getNonSkinToneEmoji(skinTone, Heart) },
            "\ud83d\udc9b" to { skinTone -> getNonSkinToneEmoji(skinTone, YellowHeart) },
            "\ud83d\udc9a" to { skinTone -> getNonSkinToneEmoji(skinTone, GreenHeart) },
            "\ud83d\udc99" to { skinTone -> getNonSkinToneEmoji(skinTone, BlueHeart) },
            "\ud83d\udc9c" to { skinTone -> getNonSkinToneEmoji(skinTone, PurpleHeart) },
            "\ud83d\udc94" to { skinTone -> getNonSkinToneEmoji(skinTone, BrokenHeart) },
            "\u2763" to { skinTone -> getNonSkinToneEmoji(skinTone, HeartExclamation) },
            "\ud83d\udc95" to { skinTone -> getNonSkinToneEmoji(skinTone, TwoHearts) },
            "\ud83d\udc9e" to { skinTone -> getNonSkinToneEmoji(skinTone, RevolvingHearts) },
            "\ud83d\udc93" to { skinTone -> getNonSkinToneEmoji(skinTone, Heartbeat) },
            "\ud83d\udc97" to { skinTone -> getNonSkinToneEmoji(skinTone, Heartpulse) },
            "\ud83d\udc96" to { skinTone -> getNonSkinToneEmoji(skinTone, SparklingHeart) },
            "\ud83d\udc98" to { skinTone -> getNonSkinToneEmoji(skinTone, Cupid) },
            "\ud83d\udc9d" to { skinTone -> getNonSkinToneEmoji(skinTone, GiftHeart) },
            "\ud83d\udc9f" to { skinTone -> getNonSkinToneEmoji(skinTone, HeartDecoration) },
            "\u262e" to { skinTone -> getNonSkinToneEmoji(skinTone, Peace) },
            "\u271d" to { skinTone -> getNonSkinToneEmoji(skinTone, Cross) },
            "\u262a" to { skinTone -> getNonSkinToneEmoji(skinTone, StarAndCrescent) },
            "\ud83d\udd49" to { skinTone -> getNonSkinToneEmoji(skinTone, OmSymbol) },
            "\u2638" to { skinTone -> getNonSkinToneEmoji(skinTone, WheelOfDharma) },
            "\u2721" to { skinTone -> getNonSkinToneEmoji(skinTone, StarOfDavid) },
            "\ud83d\udd2f" to { skinTone -> getNonSkinToneEmoji(skinTone, SixPointedStar) },
            "\ud83d\udd4e" to { skinTone -> getNonSkinToneEmoji(skinTone, Menorah) },
            "\u262f" to { skinTone -> getNonSkinToneEmoji(skinTone, YinYang) },
            "\u2626" to { skinTone -> getNonSkinToneEmoji(skinTone, OrthodoxCross) },
            "\ud83d\uded0" to { skinTone -> getNonSkinToneEmoji(skinTone, PlaceOfWorship) },
            "\u26ce" to { skinTone -> getNonSkinToneEmoji(skinTone, Ophiuchus) },
            "\u2648" to { skinTone -> getNonSkinToneEmoji(skinTone, Aries) },
            "\u2649" to { skinTone -> getNonSkinToneEmoji(skinTone, Taurus) },
            "\u264a" to { skinTone -> getNonSkinToneEmoji(skinTone, Gemini) },
            "\u264b" to { skinTone -> getNonSkinToneEmoji(skinTone, Cancer) },
            "\u264c" to { skinTone -> getNonSkinToneEmoji(skinTone, Leo) },
            "\u264d" to { skinTone -> getNonSkinToneEmoji(skinTone, Virgo) },
            "\u264e" to { skinTone -> getNonSkinToneEmoji(skinTone, Libra) },
            "\u264f" to { skinTone -> getNonSkinToneEmoji(skinTone, Scorpius) },
            "\u2650" to { skinTone -> getNonSkinToneEmoji(skinTone, Sagittarius) },
            "\u2651" to { skinTone -> getNonSkinToneEmoji(skinTone, Capricorn) },
            "\u2652" to { skinTone -> getNonSkinToneEmoji(skinTone, Aquarius) },
            "\u2653" to { skinTone -> getNonSkinToneEmoji(skinTone, Pisces) },
            "\ud83c\udd94" to { skinTone -> getNonSkinToneEmoji(skinTone, ID) },
            "\u269b" to { skinTone -> getNonSkinToneEmoji(skinTone, Atom) },
            "\ud83c\ude33" to { skinTone -> getNonSkinToneEmoji(skinTone, U7a7a) },
            "\ud83c\ude39" to { skinTone -> getNonSkinToneEmoji(skinTone, U5272) },
            "\u2622" to { skinTone -> getNonSkinToneEmoji(skinTone, Radioactive) },
            "\u2623" to { skinTone -> getNonSkinToneEmoji(skinTone, Biohazard) },
            "\ud83d\udcf4" to { skinTone -> getNonSkinToneEmoji(skinTone, MobilePhoneOff) },
            "\ud83d\udcf3" to { skinTone -> getNonSkinToneEmoji(skinTone, VibrationMode) },
            "\ud83c\ude36" to { skinTone -> getNonSkinToneEmoji(skinTone, U6709) },
            "\ud83c\ude1a" to { skinTone -> getNonSkinToneEmoji(skinTone, U7121) },
            "\ud83c\ude38" to { skinTone -> getNonSkinToneEmoji(skinTone, U7533) },
            "\ud83c\ude3a" to { skinTone -> getNonSkinToneEmoji(skinTone, U55b6) },
            "\ud83c\ude37" to { skinTone -> getNonSkinToneEmoji(skinTone, U6708) },
            "\u2734" to { skinTone -> getNonSkinToneEmoji(skinTone, EightPointedBlackStar) },
            "\ud83c\udd9a" to { skinTone -> getNonSkinToneEmoji(skinTone, VS) },
            "\ud83c\ude51" to { skinTone -> getNonSkinToneEmoji(skinTone, Accept) },
            "\ud83d\udcae" to { skinTone -> getNonSkinToneEmoji(skinTone, WhiteFlower) },
            "\ud83c\ude50" to { skinTone -> getNonSkinToneEmoji(skinTone, IdeographAdvantage) },
            "\u3299" to { skinTone -> getNonSkinToneEmoji(skinTone, Secret) },
            "\u3297" to { skinTone -> getNonSkinToneEmoji(skinTone, Congratulations) },
            "\ud83c\ude34" to { skinTone -> getNonSkinToneEmoji(skinTone, U5408) },
            "\ud83c\ude35" to { skinTone -> getNonSkinToneEmoji(skinTone, U6e80) },
            "\ud83c\ude32" to { skinTone -> getNonSkinToneEmoji(skinTone, U7981) },
            "\ud83c\udd70" to { skinTone -> getNonSkinToneEmoji(skinTone, A) },
            "\ud83c\udd71" to { skinTone -> getNonSkinToneEmoji(skinTone, B) },
            "\ud83c\udd8e" to { skinTone -> getNonSkinToneEmoji(skinTone, AB) },
            "\ud83c\udd91" to { skinTone -> getNonSkinToneEmoji(skinTone, CL) },
            "\ud83c\udd7e" to { skinTone -> getNonSkinToneEmoji(skinTone, O2) },
            "\ud83c\udd98" to { skinTone -> getNonSkinToneEmoji(skinTone, Sos) },
            "\u26d4" to { skinTone -> getNonSkinToneEmoji(skinTone, NoEntry) },
            "\ud83d\udcdb" to { skinTone -> getNonSkinToneEmoji(skinTone, NameBadge) },
            "\ud83d\udeab" to { skinTone -> getNonSkinToneEmoji(skinTone, NoEntrySign) },
            "\u274c" to { skinTone -> getNonSkinToneEmoji(skinTone, X) },
            "\u2b55" to { skinTone -> getNonSkinToneEmoji(skinTone, O) },
            "\ud83d\udca2" to { skinTone -> getNonSkinToneEmoji(skinTone, Anger) },
            "\u2668" to { skinTone -> getNonSkinToneEmoji(skinTone, Hotsprings) },
            "\ud83d\udeb7" to { skinTone -> getNonSkinToneEmoji(skinTone, NoPedestrians) },
            "\ud83d\udeaf" to { skinTone -> getNonSkinToneEmoji(skinTone, DoNotLitter) },
            "\ud83d\udeb3" to { skinTone -> getNonSkinToneEmoji(skinTone, NoBicycles) },
            "\ud83d\udeb1" to { skinTone -> getNonSkinToneEmoji(skinTone, NonPotableWater) },
            "\ud83d\udd1e" to { skinTone -> getNonSkinToneEmoji(skinTone, Underage) },
            "\ud83d\udcf5" to { skinTone -> getNonSkinToneEmoji(skinTone, NoMobilePhones) },
            "\u2757" to { skinTone -> getNonSkinToneEmoji(skinTone, Exclamation) },
            "\u2755" to { skinTone -> getNonSkinToneEmoji(skinTone, GreyExclamation) },
            "\u2753" to { skinTone -> getNonSkinToneEmoji(skinTone, Question) },
            "\u2754" to { skinTone -> getNonSkinToneEmoji(skinTone, GreyQuestion) },
            "\u203c" to { skinTone -> getNonSkinToneEmoji(skinTone, Bangbang) },
            "\u2049" to { skinTone -> getNonSkinToneEmoji(skinTone, Interrobang) },
            "\ud83d\udd05" to { skinTone -> getNonSkinToneEmoji(skinTone, LowBrightness) },
            "\ud83d\udd06" to { skinTone -> getNonSkinToneEmoji(skinTone, HighBrightness) },
            "\ud83d\udd31" to { skinTone -> getNonSkinToneEmoji(skinTone, Trident) },
            "\u269c" to { skinTone -> getNonSkinToneEmoji(skinTone, FleurDeLis) },
            "\u303d" to { skinTone -> getNonSkinToneEmoji(skinTone, PartAlternationMark) },
            "\u26a0" to { skinTone -> getNonSkinToneEmoji(skinTone, Warning) },
            "\ud83d\udeb8" to { skinTone -> getNonSkinToneEmoji(skinTone, ChildrenCrossing) },
            "\ud83d\udd30" to { skinTone -> getNonSkinToneEmoji(skinTone, Beginner) },
            "\u267b" to { skinTone -> getNonSkinToneEmoji(skinTone, Recycle) },
            "\ud83c\ude2f" to { skinTone -> getNonSkinToneEmoji(skinTone, U6307) },
            "\ud83d\udcb9" to { skinTone -> getNonSkinToneEmoji(skinTone, Chart) },
            "\u2747" to { skinTone -> getNonSkinToneEmoji(skinTone, Sparkle) },
            "\u2733" to { skinTone -> getNonSkinToneEmoji(skinTone, EightSpokedAsterisk) },
            "\u274e" to { skinTone -> getNonSkinToneEmoji(skinTone, NegativeSquaredCrossMark) },
            "\u2705" to { skinTone -> getNonSkinToneEmoji(skinTone, WhiteCheckMark) },
            "\ud83d\udca0" to { skinTone -> getNonSkinToneEmoji(skinTone, DiamondShapeWithADotInside) },
            "\ud83c\udf00" to { skinTone -> getNonSkinToneEmoji(skinTone, Cyclone) },
            "\u27bf" to { skinTone -> getNonSkinToneEmoji(skinTone, Loop) },
            "\ud83c\udf10" to { skinTone -> getNonSkinToneEmoji(skinTone, GlobeWithMeridians) },
            "\u24c2" to { skinTone -> getNonSkinToneEmoji(skinTone, M) },
            "\ud83c\udfe7" to { skinTone -> getNonSkinToneEmoji(skinTone, Atm) },
            "\ud83c\ude02" to { skinTone -> getNonSkinToneEmoji(skinTone, SA) },
            "\ud83d\udec2" to { skinTone -> getNonSkinToneEmoji(skinTone, PassportControl) },
            "\ud83d\udec3" to { skinTone -> getNonSkinToneEmoji(skinTone, Customs) },
            "\ud83d\udec4" to { skinTone -> getNonSkinToneEmoji(skinTone, BaggageClaim) },
            "\ud83d\udec5" to { skinTone -> getNonSkinToneEmoji(skinTone, LeftLuggage) },
            "\u267f" to { skinTone -> getNonSkinToneEmoji(skinTone, Wheelchair) },
            "\ud83d\udead" to { skinTone -> getNonSkinToneEmoji(skinTone, NoSmoking) },
            "\ud83d\udebe" to { skinTone -> getNonSkinToneEmoji(skinTone, WC) },
            "\ud83c\udd7f" to { skinTone -> getNonSkinToneEmoji(skinTone, Parking) },
            "\ud83d\udeb0" to { skinTone -> getNonSkinToneEmoji(skinTone, PotableWater) },
            "\ud83d\udeb9" to { skinTone -> getNonSkinToneEmoji(skinTone, Mens) },
            "\ud83d\udeba" to { skinTone -> getNonSkinToneEmoji(skinTone, Womens) },
            "\ud83d\udebc" to { skinTone -> getNonSkinToneEmoji(skinTone, BabySymbol) },
            "\ud83d\udebb" to { skinTone -> getNonSkinToneEmoji(skinTone, Restroom) },
            "\ud83d\udeae" to { skinTone -> getNonSkinToneEmoji(skinTone, PutLitterInItsPlace) },
            "\ud83c\udfa6" to { skinTone -> getNonSkinToneEmoji(skinTone, Cinema) },
            "\ud83d\udcf6" to { skinTone -> getNonSkinToneEmoji(skinTone, SignalStrength) },
            "\ud83c\ude01" to { skinTone -> getNonSkinToneEmoji(skinTone, Koko) },
            "\ud83c\udd96" to { skinTone -> getNonSkinToneEmoji(skinTone, NG) },
            "\ud83c\udd97" to { skinTone -> getNonSkinToneEmoji(skinTone, OK) },
            "\ud83c\udd99" to { skinTone -> getNonSkinToneEmoji(skinTone, UP) },
            "\ud83c\udd92" to { skinTone -> getNonSkinToneEmoji(skinTone, Cool) },
            "\ud83c\udd95" to { skinTone -> getNonSkinToneEmoji(skinTone, New) },
            "\ud83c\udd93" to { skinTone -> getNonSkinToneEmoji(skinTone, Free) },
            "\u0030\u20e3" to { skinTone -> getNonSkinToneEmoji(skinTone, Zero) },
            "\u0031\u20e3" to { skinTone -> getNonSkinToneEmoji(skinTone, One) },
            "\u0032\u20e3" to { skinTone -> getNonSkinToneEmoji(skinTone, Two) },
            "\u0033\u20e3" to { skinTone -> getNonSkinToneEmoji(skinTone, Three) },
            "\u0034\u20e3" to { skinTone -> getNonSkinToneEmoji(skinTone, Four) },
            "\u0035\u20e3" to { skinTone -> getNonSkinToneEmoji(skinTone, Five) },
            "\u0036\u20e3" to { skinTone -> getNonSkinToneEmoji(skinTone, Six) },
            "\u0037\u20e3" to { skinTone -> getNonSkinToneEmoji(skinTone, Seven) },
            "\u0038\u20e3" to { skinTone -> getNonSkinToneEmoji(skinTone, Eight) },
            "\u0039\u20e3" to { skinTone -> getNonSkinToneEmoji(skinTone, Nine) },
            "\ud83d\udd1f" to { skinTone -> getNonSkinToneEmoji(skinTone, Ten) },
            "\u25b6" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowForward) },
            "\u23f8" to { skinTone -> getNonSkinToneEmoji(skinTone, PauseButton) },
            "\u23ef" to { skinTone -> getNonSkinToneEmoji(skinTone, PlayPause) },
            "\u23f9" to { skinTone -> getNonSkinToneEmoji(skinTone, StopButton) },
            "\u23fa" to { skinTone -> getNonSkinToneEmoji(skinTone, RecordButton) },
            "\u23ed" to { skinTone -> getNonSkinToneEmoji(skinTone, TrackNext) },
            "\u23ee" to { skinTone -> getNonSkinToneEmoji(skinTone, TrackPrevious) },
            "\u23e9" to { skinTone -> getNonSkinToneEmoji(skinTone, FastForward) },
            "\u23ea" to { skinTone -> getNonSkinToneEmoji(skinTone, Rewind) },
            "\ud83d\udd00" to { skinTone -> getNonSkinToneEmoji(skinTone, TwistedRightwardsArrows) },
            "\ud83d\udd01" to { skinTone -> getNonSkinToneEmoji(skinTone, Repeat) },
            "\ud83d\udd02" to { skinTone -> getNonSkinToneEmoji(skinTone, RepeatOne) },
            "\u25c0" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowBackward) },
            "\ud83d\udd3c" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowUpSmall) },
            "\ud83d\udd3d" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowDownSmall) },
            "\u23eb" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowDoubleUp) },
            "\u23ec" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowDoubleDown) },
            "\u27a1" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowRight) },
            "\u2b05" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowLeft) },
            "\u2b06" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowUp) },
            "\u2b07" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowDown) },
            "\u2197" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowUpperRight) },
            "\u2198" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowLowerRight) },
            "\u2199" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowLowerLeft) },
            "\u2196" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowUpperLeft) },
            "\u2195" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowUpDown) },
            "\u2194" to { skinTone -> getNonSkinToneEmoji(skinTone, LeftRightArrow) },
            "\ud83d\udd04" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowsCounterclockwise) },
            "\u21aa" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowRightHook) },
            "\u21a9" to { skinTone -> getNonSkinToneEmoji(skinTone, LeftwardsArrowWithHook) },
            "\u2934" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowHeadingUp) },
            "\u2935" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowHeadingDown) },
            "\u0023\u20e3" to { skinTone -> getNonSkinToneEmoji(skinTone, Hash) },
            "\u002a\u20e3" to { skinTone -> getNonSkinToneEmoji(skinTone, Asterisk) },
            "\u2139" to { skinTone -> getNonSkinToneEmoji(skinTone, InformationSource) },
            "\ud83d\udd24" to { skinTone -> getNonSkinToneEmoji(skinTone, Abc) },
            "\ud83d\udd21" to { skinTone -> getNonSkinToneEmoji(skinTone, Abcd) },
            "\ud83d\udd20" to { skinTone -> getNonSkinToneEmoji(skinTone, CapitalAbcd) },
            "\ud83d\udd23" to { skinTone -> getNonSkinToneEmoji(skinTone, Symbols) },
            "\ud83c\udfb5" to { skinTone -> getNonSkinToneEmoji(skinTone, MusicalNote) },
            "\ud83c\udfb6" to { skinTone -> getNonSkinToneEmoji(skinTone, Notes) },
            "\u3030" to { skinTone -> getNonSkinToneEmoji(skinTone, WavyDash) },
            "\u27b0" to { skinTone -> getNonSkinToneEmoji(skinTone, CurlyLoop) },
            "\u2714" to { skinTone -> getNonSkinToneEmoji(skinTone, HeavyCheckMark) },
            "\ud83d\udd03" to { skinTone -> getNonSkinToneEmoji(skinTone, ArrowsClockwise) },
            "\u2795" to { skinTone -> getNonSkinToneEmoji(skinTone, HeavyPlusSign) },
            "\u2796" to { skinTone -> getNonSkinToneEmoji(skinTone, HeavyMinusSign) },
            "\u2797" to { skinTone -> getNonSkinToneEmoji(skinTone, HeavyDivisionSign) },
            "\u2716" to { skinTone -> getNonSkinToneEmoji(skinTone, HeavyMultiplicationX) },
            "\ud83d\udcb2" to { skinTone -> getNonSkinToneEmoji(skinTone, HeavyDollarSign) },
            "\ud83d\udcb1" to { skinTone -> getNonSkinToneEmoji(skinTone, CurrencyExchange) },
            "\u00a9" to { skinTone -> getNonSkinToneEmoji(skinTone, Copyright) },
            "\u00ae" to { skinTone -> getNonSkinToneEmoji(skinTone, Registered) },
            "\u2122" to { skinTone -> getNonSkinToneEmoji(skinTone, TM) },
            "\ud83d\udd1a" to { skinTone -> getNonSkinToneEmoji(skinTone, End) },
            "\ud83d\udd19" to { skinTone -> getNonSkinToneEmoji(skinTone, Back) },
            "\ud83d\udd1b" to { skinTone -> getNonSkinToneEmoji(skinTone, ON) },
            "\ud83d\udd1d" to { skinTone -> getNonSkinToneEmoji(skinTone, Top) },
            "\ud83d\udd1c" to { skinTone -> getNonSkinToneEmoji(skinTone, Soon) },
            "\u2611" to { skinTone -> getNonSkinToneEmoji(skinTone, BallotBoxWithCheck) },
            "\ud83d\udd18" to { skinTone -> getNonSkinToneEmoji(skinTone, RadioButton) },
            "\u26aa" to { skinTone -> getNonSkinToneEmoji(skinTone, WhiteCircle) },
            "\u26ab" to { skinTone -> getNonSkinToneEmoji(skinTone, BlackCircle) },
            "\ud83d\udd34" to { skinTone -> getNonSkinToneEmoji(skinTone, RedCircle) },
            "\ud83d\udd35" to { skinTone -> getNonSkinToneEmoji(skinTone, LargeBlueCircle) },
            "\ud83d\udd38" to { skinTone -> getNonSkinToneEmoji(skinTone, SmallOrangeDiamond) },
            "\ud83d\udd39" to { skinTone -> getNonSkinToneEmoji(skinTone, SmallBlueDiamond) },
            "\ud83d\udd36" to { skinTone -> getNonSkinToneEmoji(skinTone, LargeOrangeDiamond) },
            "\ud83d\udd37" to { skinTone -> getNonSkinToneEmoji(skinTone, LargeBlueDiamond) },
            "\ud83d\udd3a" to { skinTone -> getNonSkinToneEmoji(skinTone, SmallRedTriangle) },
            "\u25aa" to { skinTone -> getNonSkinToneEmoji(skinTone, BlackSmallSquare) },
            "\u25ab" to { skinTone -> getNonSkinToneEmoji(skinTone, WhiteSmallSquare) },
            "\u2b1b" to { skinTone -> getNonSkinToneEmoji(skinTone, BlackLargeSquare) },
            "\u2b1c" to { skinTone -> getNonSkinToneEmoji(skinTone, WhiteLargeSquare) },
            "\ud83d\udd3b" to { skinTone -> getNonSkinToneEmoji(skinTone, SmallRedTriangleDown) },
            "\u25fc" to { skinTone -> getNonSkinToneEmoji(skinTone, BlackMediumSquare) },
            "\u25fb" to { skinTone -> getNonSkinToneEmoji(skinTone, WhiteMediumSquare) },
            "\u25fe" to { skinTone -> getNonSkinToneEmoji(skinTone, BlackMediumSmallSquare) },
            "\u25fd" to { skinTone -> getNonSkinToneEmoji(skinTone, WhiteMediumSmallSquare) },
            "\ud83d\udd32" to { skinTone -> getNonSkinToneEmoji(skinTone, BlackSquareButton) },
            "\ud83d\udd33" to { skinTone -> getNonSkinToneEmoji(skinTone, WhiteSquareButton) },
            "\ud83d\udd08" to { skinTone -> getNonSkinToneEmoji(skinTone, Speaker) },
            "\ud83d\udd09" to { skinTone -> getNonSkinToneEmoji(skinTone, Sound) },
            "\ud83d\udd0a" to { skinTone -> getNonSkinToneEmoji(skinTone, LoudSound) },
            "\ud83d\udd07" to { skinTone -> getNonSkinToneEmoji(skinTone, Mute) },
            "\ud83d\udce3" to { skinTone -> getNonSkinToneEmoji(skinTone, Mega) },
            "\ud83d\udce2" to { skinTone -> getNonSkinToneEmoji(skinTone, Loudspeaker) },
            "\ud83d\udd14" to { skinTone -> getNonSkinToneEmoji(skinTone, Bell) },
            "\ud83d\udd15" to { skinTone -> getNonSkinToneEmoji(skinTone, NoBell) },
            "\ud83c\udccf" to { skinTone -> getNonSkinToneEmoji(skinTone, BlackJoker) },
            "\ud83c\udc04" to { skinTone -> getNonSkinToneEmoji(skinTone, Mahjong) },
            "\u2660" to { skinTone -> getNonSkinToneEmoji(skinTone, Spades) },
            "\u2663" to { skinTone -> getNonSkinToneEmoji(skinTone, Clubs) },
            "\u2665" to { skinTone -> getNonSkinToneEmoji(skinTone, Hearts) },
            "\u2666" to { skinTone -> getNonSkinToneEmoji(skinTone, Diamonds) },
            "\ud83c\udfb4" to { skinTone -> getNonSkinToneEmoji(skinTone, FlowerPlayingCards) },
            "\ud83d\udcad" to { skinTone -> getNonSkinToneEmoji(skinTone, ThoughtBalloon) },
            "\ud83d\uddef" to { skinTone -> getNonSkinToneEmoji(skinTone, AngerRight) },
            "\ud83d\udcac" to { skinTone -> getNonSkinToneEmoji(skinTone, SpeechBalloon) },
            "\ud83d\udd50" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock1) },
            "\ud83d\udd51" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock2) },
            "\ud83d\udd52" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock3) },
            "\ud83d\udd53" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock4) },
            "\ud83d\udd54" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock5) },
            "\ud83d\udd55" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock6) },
            "\ud83d\udd56" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock7) },
            "\ud83d\udd57" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock8) },
            "\ud83d\udd58" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock9) },
            "\ud83d\udd59" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock10) },
            "\ud83d\udd5a" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock11) },
            "\ud83d\udd5b" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock12) },
            "\ud83d\udd5c" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock130) },
            "\ud83d\udd5d" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock230) },
            "\ud83d\udd5e" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock330) },
            "\ud83d\udd5f" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock430) },
            "\ud83d\udd60" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock530) },
            "\ud83d\udd61" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock630) },
            "\ud83d\udd62" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock730) },
            "\ud83d\udd63" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock830) },
            "\ud83d\udd64" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock930) },
            "\ud83d\udd65" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock1030) },
            "\ud83d\udd66" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock1130) },
            "\ud83d\udd67" to { skinTone -> getNonSkinToneEmoji(skinTone, Clock1230) },
            "\ud83d\udc41\u200d\ud83d\udde8" to { skinTone -> getNonSkinToneEmoji(skinTone, EyeInSpeechBubble) },
            "\ud83d\udde8" to { skinTone -> getNonSkinToneEmoji(skinTone, SpeechLeft) },
            "\u23cf" to { skinTone -> getNonSkinToneEmoji(skinTone, Eject) },
            "\ud83d\udda4" to { skinTone -> getNonSkinToneEmoji(skinTone, BlackHeart) },
            "\ud83d\uded1" to { skinTone -> getNonSkinToneEmoji(skinTone, StopSign) },
            "\ud83c\uddff" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorZ) },
            "\ud83c\uddfe" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorY) },
            "\ud83c\uddfd" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorX) },
            "\ud83c\uddfc" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorW) },
            "\ud83c\uddfb" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorV) },
            "\ud83c\uddfa" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorU) },
            "\ud83c\uddf9" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorT) },
            "\ud83c\uddf8" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorS) },
            "\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorR) },
            "\ud83c\uddf6" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorQ) },
            "\ud83c\uddf5" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorP) },
            "\ud83c\uddf4" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorO) },
            "\ud83c\uddf3" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorN) },
            "\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorM) },
            "\ud83c\uddf1" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorL) },
            "\ud83c\uddf0" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorK) },
            "\ud83c\uddef" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorJ) },
            "\ud83c\uddee" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorI) },
            "\ud83c\udded" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorH) },
            "\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorG) },
            "\ud83c\uddeb" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorF) },
            "\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorE) },
            "\ud83c\udde9" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorD) },
            "\ud83c\udde8" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorC) },
            "\ud83c\udde7" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorB) },
            "\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, RegionalIndicatorA) },
            "\ud83c\udde6\ud83c\udde8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAC) },
            "\ud83c\udde6\ud83c\udde9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAD) },
            "\ud83c\udde6\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAE) },
            "\ud83c\udde6\ud83c\uddeb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAF) },
            "\ud83c\udde6\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAG) },
            "\ud83c\udde6\ud83c\uddee" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAI) },
            "\ud83c\udde6\ud83c\uddf1" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAL) },
            "\ud83c\udde6\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAM) },
            "\ud83c\udde6\ud83c\uddf4" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAO) },
            "\ud83c\udde6\ud83c\uddf6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAQ) },
            "\ud83c\udde6\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAR) },
            "\ud83c\udde6\ud83c\uddf8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAS) },
            "\ud83c\udde6\ud83c\uddf9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAT) },
            "\ud83c\udde6\ud83c\uddfa" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAU) },
            "\ud83c\udde6\ud83c\uddfc" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAW) },
            "\ud83c\udde6\ud83c\uddfd" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAX) },
            "\ud83c\udde6\ud83c\uddff" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagAZ) },
            "\ud83c\udde7\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBA) },
            "\ud83c\udde7\ud83c\udde7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBB) },
            "\ud83c\udde7\ud83c\udde9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBD) },
            "\ud83c\udde7\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBE) },
            "\ud83c\udde7\ud83c\uddeb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBF) },
            "\ud83c\udde7\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBG) },
            "\ud83c\udde7\ud83c\udded" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBH) },
            "\ud83c\udde7\ud83c\uddee" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBI) },
            "\ud83c\udde7\ud83c\uddef" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBJ) },
            "\ud83c\udde7\ud83c\uddf1" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBL) },
            "\ud83c\udde7\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBM) },
            "\ud83c\udde7\ud83c\uddf3" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBN) },
            "\ud83c\udde7\ud83c\uddf4" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBO) },
            "\ud83c\udde7\ud83c\uddf6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBQ) },
            "\ud83c\udde7\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBR) },
            "\ud83c\udde7\ud83c\uddf8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBS) },
            "\ud83c\udde7\ud83c\uddf9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBT) },
            "\ud83c\udde7\ud83c\uddfb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBV) },
            "\ud83c\udde7\ud83c\uddfc" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBW) },
            "\ud83c\udde7\ud83c\uddfe" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBY) },
            "\ud83c\udde7\ud83c\uddff" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagBZ) },
            "\ud83c\udde8\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCA) },
            "\ud83c\udde8\ud83c\udde8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCC) },
            "\ud83c\udde8\ud83c\udde9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCD) },
            "\ud83c\udde8\ud83c\uddeb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCF) },
            "\ud83c\udde8\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCG) },
            "\ud83c\udde8\ud83c\udded" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCH) },
            "\ud83c\udde8\ud83c\uddee" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCI) },
            "\ud83c\udde8\ud83c\uddf0" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCK) },
            "\ud83c\udde8\ud83c\uddf1" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCL) },
            "\ud83c\udde8\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCM) },
            "\ud83c\udde8\ud83c\uddf3" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCN) },
            "\ud83c\udde8\ud83c\uddf4" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCO) },
            "\ud83c\udde8\ud83c\uddf5" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCP) },
            "\ud83c\udde8\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCR) },
            "\ud83c\udde8\ud83c\uddfa" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCU) },
            "\ud83c\udde8\ud83c\uddfb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCV) },
            "\ud83c\udde8\ud83c\uddfc" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCW) },
            "\ud83c\udde8\ud83c\uddfd" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCX) },
            "\ud83c\udde8\ud83c\uddfe" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCY) },
            "\ud83c\udde8\ud83c\uddff" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagCZ) },
            "\ud83c\udde9\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagDE) },
            "\ud83c\udde9\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagDG) },
            "\ud83c\udde9\ud83c\uddef" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagDJ) },
            "\ud83c\udde9\ud83c\uddf0" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagDK) },
            "\ud83c\udde9\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagDM) },
            "\ud83c\udde9\ud83c\uddf4" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagDO) },
            "\ud83c\udde9\ud83c\uddff" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagDZ) },
            "\ud83c\uddea\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagEA) },
            "\ud83c\uddea\ud83c\udde8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagEC) },
            "\ud83c\uddea\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagEE) },
            "\ud83c\uddea\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagEG) },
            "\ud83c\uddea\ud83c\udded" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagEH) },
            "\ud83c\uddea\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagER) },
            "\ud83c\uddea\ud83c\uddf8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagES) },
            "\ud83c\uddea\ud83c\uddf9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagET) },
            "\ud83c\uddea\ud83c\uddfa" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagEU) },
            "\ud83c\uddeb\ud83c\uddee" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagFI) },
            "\ud83c\uddeb\ud83c\uddef" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagFJ) },
            "\ud83c\uddeb\ud83c\uddf0" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagFK) },
            "\ud83c\uddeb\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagFM) },
            "\ud83c\uddeb\ud83c\uddf4" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagFO) },
            "\ud83c\uddeb\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagFR) },
            "\ud83c\uddec\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGA) },
            "\ud83c\uddec\ud83c\udde7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGB) },
            "\ud83c\uddec\ud83c\udde9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGD) },
            "\ud83c\uddec\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGE) },
            "\ud83c\uddec\ud83c\uddeb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGF) },
            "\ud83c\uddec\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGG) },
            "\ud83c\uddec\ud83c\udded" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGH) },
            "\ud83c\uddec\ud83c\uddee" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGI) },
            "\ud83c\uddec\ud83c\uddf1" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGL) },
            "\ud83c\uddec\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGM) },
            "\ud83c\uddec\ud83c\uddf3" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGN) },
            "\ud83c\uddec\ud83c\uddf5" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGP) },
            "\ud83c\uddec\ud83c\uddf6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGQ) },
            "\ud83c\uddec\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGR) },
            "\ud83c\uddec\ud83c\uddf8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGS) },
            "\ud83c\uddec\ud83c\uddf9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGT) },
            "\ud83c\uddec\ud83c\uddfa" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGU) },
            "\ud83c\uddec\ud83c\uddfc" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGW) },
            "\ud83c\uddec\ud83c\uddfe" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagGY) },
            "\ud83c\udded\ud83c\uddf0" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagHK) },
            "\ud83c\udded\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagHM) },
            "\ud83c\udded\ud83c\uddf3" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagHN) },
            "\ud83c\udded\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagHR) },
            "\ud83c\udded\ud83c\uddf9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagHT) },
            "\ud83c\udded\ud83c\uddfa" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagHU) },
            "\ud83c\uddee\ud83c\udde8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagIC) },
            "\ud83c\uddee\ud83c\udde9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagID) },
            "\ud83c\uddee\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagIE) },
            "\ud83c\uddee\ud83c\uddf1" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagIL) },
            "\ud83c\uddee\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagIM) },
            "\ud83c\uddee\ud83c\uddf3" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagIN) },
            "\ud83c\uddee\ud83c\uddf4" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagIO) },
            "\ud83c\uddee\ud83c\uddf6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagIQ) },
            "\ud83c\uddee\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagIR) },
            "\ud83c\uddee\ud83c\uddf8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagIS) },
            "\ud83c\uddee\ud83c\uddf9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagIT) },
            "\ud83c\uddef\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagJE) },
            "\ud83c\uddef\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagJM) },
            "\ud83c\uddef\ud83c\uddf4" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagJO) },
            "\ud83c\uddef\ud83c\uddf5" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagJP) },
            "\ud83c\uddf0\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagKE) },
            "\ud83c\uddf0\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagKG) },
            "\ud83c\uddf0\ud83c\udded" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagKH) },
            "\ud83c\uddf0\ud83c\uddee" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagKI) },
            "\ud83c\uddf0\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagKM) },
            "\ud83c\uddf0\ud83c\uddf3" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagKN) },
            "\ud83c\uddf0\ud83c\uddf5" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagKP) },
            "\ud83c\uddf0\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagKR) },
            "\ud83c\uddf0\ud83c\uddfc" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagKW) },
            "\ud83c\uddf0\ud83c\uddfe" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagKY) },
            "\ud83c\uddf0\ud83c\uddff" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagKZ) },
            "\ud83c\uddf1\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagLA) },
            "\ud83c\uddf1\ud83c\udde7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagLB) },
            "\ud83c\uddf1\ud83c\udde8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagLC) },
            "\ud83c\uddf1\ud83c\uddee" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagLI) },
            "\ud83c\uddf1\ud83c\uddf0" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagLK) },
            "\ud83c\uddf1\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagLR) },
            "\ud83c\uddf1\ud83c\uddf8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagLS) },
            "\ud83c\uddf1\ud83c\uddf9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagLT) },
            "\ud83c\uddf1\ud83c\uddfa" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagLU) },
            "\ud83c\uddf1\ud83c\uddfb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagLV) },
            "\ud83c\uddf1\ud83c\uddfe" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagLY) },
            "\ud83c\uddf2\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMA) },
            "\ud83c\uddf2\ud83c\udde8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMC) },
            "\ud83c\uddf2\ud83c\udde9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMD) },
            "\ud83c\uddf2\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagME) },
            "\ud83c\uddf2\ud83c\uddeb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMF) },
            "\ud83c\uddf2\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMG) },
            "\ud83c\uddf2\ud83c\udded" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMH) },
            "\ud83c\uddf2\ud83c\uddf0" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMK) },
            "\ud83c\uddf2\ud83c\uddf1" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagML) },
            "\ud83c\uddf2\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMM) },
            "\ud83c\uddf2\ud83c\uddf3" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMN) },
            "\ud83c\uddf2\ud83c\uddf4" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMO) },
            "\ud83c\uddf2\ud83c\uddf5" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMP) },
            "\ud83c\uddf2\ud83c\uddf6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMQ) },
            "\ud83c\uddf2\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMR) },
            "\ud83c\uddf2\ud83c\uddf8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMS) },
            "\ud83c\uddf2\ud83c\uddf9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMT) },
            "\ud83c\uddf2\ud83c\uddfa" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMU) },
            "\ud83c\uddf2\ud83c\uddfb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMV) },
            "\ud83c\uddf2\ud83c\uddfc" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMW) },
            "\ud83c\uddf2\ud83c\uddfd" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMX) },
            "\ud83c\uddf2\ud83c\uddfe" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMY) },
            "\ud83c\uddf2\ud83c\uddff" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagMZ) },
            "\ud83c\uddf3\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagNA) },
            "\ud83c\uddf3\ud83c\udde8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagNC) },
            "\ud83c\uddf3\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagNE) },
            "\ud83c\uddf3\ud83c\uddeb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagNF) },
            "\ud83c\uddf3\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagNG) },
            "\ud83c\uddf3\ud83c\uddee" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagNI) },
            "\ud83c\uddf3\ud83c\uddf1" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagNL) },
            "\ud83c\uddf3\ud83c\uddf4" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagNO) },
            "\ud83c\uddf3\ud83c\uddf5" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagNP) },
            "\ud83c\uddf3\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagNR) },
            "\ud83c\uddf3\ud83c\uddfa" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagNU) },
            "\ud83c\uddf3\ud83c\uddff" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagNZ) },
            "\ud83c\uddf4\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagOM) },
            "\ud83c\uddf5\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagPA) },
            "\ud83c\uddf5\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagPE) },
            "\ud83c\uddf5\ud83c\uddeb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagPF) },
            "\ud83c\uddf5\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagPG) },
            "\ud83c\uddf5\ud83c\udded" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagPH) },
            "\ud83c\uddf5\ud83c\uddf0" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagPK) },
            "\ud83c\uddf5\ud83c\uddf1" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagPL) },
            "\ud83c\uddf5\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagPM) },
            "\ud83c\uddf5\ud83c\uddf3" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagPN) },
            "\ud83c\uddf5\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagPR) },
            "\ud83c\uddf5\ud83c\uddf8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagPS) },
            "\ud83c\uddf5\ud83c\uddf9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagPT) },
            "\ud83c\uddf5\ud83c\uddfc" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagPW) },
            "\ud83c\uddf5\ud83c\uddfe" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagPY) },
            "\ud83c\uddf6\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagQA) },
            "\ud83c\uddf7\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagRE) },
            "\ud83c\uddf7\ud83c\uddf4" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagRO) },
            "\ud83c\uddf7\ud83c\uddf8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagRS) },
            "\ud83c\uddf7\ud83c\uddfa" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagRU) },
            "\ud83c\uddf7\ud83c\uddfc" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagRW) },
            "\ud83c\uddf8\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSA) },
            "\ud83c\uddf8\ud83c\udde7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSB) },
            "\ud83c\uddf8\ud83c\udde8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSC) },
            "\ud83c\uddf8\ud83c\udde9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSD) },
            "\ud83c\uddf8\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSE) },
            "\ud83c\uddf8\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSG) },
            "\ud83c\uddf8\ud83c\udded" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSH) },
            "\ud83c\uddf8\ud83c\uddee" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSI) },
            "\ud83c\uddf8\ud83c\uddef" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSJ) },
            "\ud83c\uddf8\ud83c\uddf0" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSK) },
            "\ud83c\uddf8\ud83c\uddf1" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSL) },
            "\ud83c\uddf8\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSM) },
            "\ud83c\uddf8\ud83c\uddf3" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSN) },
            "\ud83c\uddf8\ud83c\uddf4" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSO) },
            "\ud83c\uddf8\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSR) },
            "\ud83c\uddf8\ud83c\uddf8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSS) },
            "\ud83c\uddf8\ud83c\uddf9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagST) },
            "\ud83c\uddf8\ud83c\uddfb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSV) },
            "\ud83c\uddf8\ud83c\uddfd" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSX) },
            "\ud83c\uddf8\ud83c\uddfe" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSY) },
            "\ud83c\uddf8\ud83c\uddff" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagSZ) },
            "\ud83c\uddf9\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTA) },
            "\ud83c\uddf9\ud83c\udde8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTC) },
            "\ud83c\uddf9\ud83c\udde9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTD) },
            "\ud83c\uddf9\ud83c\uddeb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTF) },
            "\ud83c\uddf9\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTG) },
            "\ud83c\uddf9\ud83c\udded" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTH) },
            "\ud83c\uddf9\ud83c\uddef" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTJ) },
            "\ud83c\uddf9\ud83c\uddf0" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTK) },
            "\ud83c\uddf9\ud83c\uddf1" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTL) },
            "\ud83c\uddf9\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTM) },
            "\ud83c\uddf9\ud83c\uddf3" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTN) },
            "\ud83c\uddf9\ud83c\uddf4" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTO) },
            "\ud83c\uddf9\ud83c\uddf7" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTR) },
            "\ud83c\uddf9\ud83c\uddf9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTT) },
            "\ud83c\uddf9\ud83c\uddfb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTV) },
            "\ud83c\uddf9\ud83c\uddfc" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTW) },
            "\ud83c\uddf9\ud83c\uddff" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagTZ) },
            "\ud83c\uddfa\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagUA) },
            "\ud83c\uddfa\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagUG) },
            "\ud83c\uddfa\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagUM) },
            "\ud83c\uddfa\ud83c\uddf8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagUS) },
            "\ud83c\uddfa\ud83c\uddfe" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagUY) },
            "\ud83c\uddfa\ud83c\uddff" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagUZ) },
            "\ud83c\uddfb\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagVA) },
            "\ud83c\uddfb\ud83c\udde8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagVC) },
            "\ud83c\uddfb\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagVE) },
            "\ud83c\uddfb\ud83c\uddec" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagVG) },
            "\ud83c\uddfb\ud83c\uddee" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagVI) },
            "\ud83c\uddfb\ud83c\uddf3" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagVN) },
            "\ud83c\uddfb\ud83c\uddfa" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagVU) },
            "\ud83c\uddfc\ud83c\uddeb" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagWF) },
            "\ud83c\uddfc\ud83c\uddf8" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagWS) },
            "\ud83c\uddfd\ud83c\uddf0" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagXK) },
            "\ud83c\uddfe\ud83c\uddea" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagYE) },
            "\ud83c\uddfe\ud83c\uddf9" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagYT) },
            "\ud83c\uddff\ud83c\udde6" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagZA) },
            "\ud83c\uddff\ud83c\uddf2" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagZM) },
            "\ud83c\uddff\ud83c\uddfc" to { skinTone -> getNonSkinToneEmoji(skinTone, FlagZW) },
            "\ud83c\udff3\ufe0f\u200d\ud83c\udf08" to { skinTone -> getNonSkinToneEmoji(skinTone, GayPrideFlag) }
        )

        /** Creates a unicode emoji from the given [unicode] string. */
        operator fun invoke(unicode: String): UnicodeEmoji {
            val unicodeLength = unicode.length.minus(2).takeIf { it >= 0 }
            val skinTone = unicodeLength?.let { skinToneMap[unicode.substring(it)] }
            val emoji = emojiMap[skinTone?.let { unicode.substring(0, unicodeLength) } ?: unicode]

            require(emoji != null) { "No such emoji: $unicode" }

            return emoji(skinTone)
        }

        /** Return an [emoji] and throw an exception if it has a [skinTone]. */
        private fun getNonSkinToneEmoji(skinTone: SkinTone?, emoji: UnicodeEmoji): UnicodeEmoji {
            require(skinTone == null) { "This emoji ($emoji) cannot have a SkinTone ($skinTone)." }
