 ...
 * "normal." Although they are similar, bot users are automated users that
 ...
 *
 * @param data The [UserData] to generate this [User] [Entity] from
 */
data class User internal constructor(private val data: UserData) : Entity {
    override val id = data.id
    override val context = data.context
    /**
     * The username represents the most basic form of identification for any
     * Discord user. Usernames are not unique across Discord, and as such,
     * several users can share the same username. However, no two users can
     * share the same username/discriminator combination.
     *
     * There are a few Discord-enforced restrictions for usernames, and they are
     * as follows:
     *
