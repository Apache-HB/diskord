...
internal fun <T : EntityData> MutableMap<Long, T>.put(data: T) = put(data.id, data)

internal fun <T : EntityData> MutableMap<Long, T>.putAll(elements: Iterable<T>) = putAll(elements.associateBy { it.id })
